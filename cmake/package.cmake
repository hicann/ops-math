...
function(pack_built_in)
  ...
  # CPack component name uses a hyphen, while version.cmake registers ops_math.
  set(CANN_VERSION_ops-math_VERSION "${CANN_VERSION_ops_math_VERSION}")
  set(CANN_VERSION_ops-math_VERSION_MAJOR_MINOR "${CANN_VERSION_ops_math_VERSION_MAJOR_MINOR}")
  set_cann_cpack_config(ops-math COMPUTE_UNIT ${ASCEND_COMPUTE_UNIT} SHARE_INFO_NAME ops_math PACKAGE_TYPE "${PACKAGE_TYPE}")
endfunction()
