...
#include "../op_kernel/logical_or_tiling_data.h"
#include "../op_kernel/logical_or_tiling_key.h"
...
static ge::graphStatus LogicalOrTilingFunc(gert::TilingContext* context)
{
    LogicalOrTilingData* tiling = context->GetTilingData<LogicalOrTilingData>();
...
static ge::graphStatus TilingParseForLogicalOr([[maybe_unused]] gert::TilingParseContext* context)
{
    return ge::GRAPH_SUCCESS;
}
