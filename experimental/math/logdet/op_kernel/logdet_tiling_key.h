...
/*!
 * \file logdet_tiling_key.h
 * \brief Logdet TilingKey 模板参数声明（现代规范：ASCENDC_TPL_*，禁用整型常量宏 + TILING_KEY_IS）。
 *
 * 模板参数:
...
#ifndef LOGDET_TILING_KEY_H
#define LOGDET_TILING_KEY_H

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(Logdet,
