...
- **参数说明：**
  ...
  * self(aclTensor*, 计算输入)：Device侧的aclTensor，支持1维~8维。支持[非连续的Tensor](../../../../docs/context/非连续的Tensor.md)，[数据格式](../../../../docs/context/数据格式.md)支持ND。
    - <term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：数据类型支持BOOL、INT64、INT32、INT16、INT8、UINT8、FLOAT、FLOAT16、DOUBLE、COMPLEX64、COMPLEX128、BFLOAT16。
