...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        !shapeMatch,
        OP_LOGE(
            context, "DotV2: inputx,inputy shape not match! dim num: x=%zu,  y=%zu", inputShapeX.GetDimNum(),
...
static ge::graphStatus DotV2TilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_NULL_WITH_CONTEXT(context, tiling);
    OP_CHECK_IF(
        memset_s(tiling, sizeof(DotV2TilingData), 0, sizeof(DotV2TilingData)) != EOK,
    ...
    uint32_t smallTailDataNum_i = static_cast<uint32_t>(smallCoreDataNum) -
                                  static_cast<uint32_t>(tileDataNum) * static_cast<uint32_t>(smallTileNum);
    ...
    uint32_t bigTailDataNum_i =
        static_cast<uint32_t>(bigCoreDataNum) - static_cast<uint32_t>(tileDataNum) * static_cast<uint32_t>(bigTileNum);
