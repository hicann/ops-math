 ...
 * \brief TilingKey template parameter definition for CoshV2 operator (arch22)
 *
 * Template parameters:
...
ASCENDC_TPL_ARGS_DECL(CoshV2, ASCENDC_TPL_DATATYPE_DECL(D_T, C_DT_FLOAT16, C_DT_FLOAT, C_DT_BF16, ASCENDC_TPL_INPUT(0)),
