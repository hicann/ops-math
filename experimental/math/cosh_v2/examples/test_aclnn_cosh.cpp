...
int main()
{
    ...
    // 第二段: 执行计算
    ret = aclnnCoshV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnCoshV2 failed. ERROR: %d\n", ret); return ret);
