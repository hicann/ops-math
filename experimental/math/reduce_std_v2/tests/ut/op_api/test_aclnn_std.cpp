...
#include "experimental/math/reduce_std_v2/op_api/aclnn_std.h"
#include "op_api_ut_common/tensor_desc.h"
#include "op_api_ut_common/scalar_desc.h"
#include "op_api_ut_common/op_api_ut.h"

class TestAclnnStd : public testing::Test {
public:
    template <typename T>
...
protected:
    ...
    {
        std::cout << "TestAclnnStd SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestAclnnStd TearDown" << std::endl;
    }
};

// 正常场景_float32_nd_dim为0_keepdim为true
TEST_F(TestAclnnStd, normal_dtype_float32_format_nd_dim_0_keepdim_true)
{
...
TEST_F(TestAclnnStd, normal_dtype_float32_format_nchw_dim_1_keepdim_false)
{
...
TEST_F(TestAclnnStd, normal_dtype_float32_format_nhwc_dim_2_keepdim_false)
{
...
TEST_F(TestAclnnStd, normal_dtype_float16_format_hwcn_dim_2_keepdim_true)
{
...
TEST_F(TestAclnnStd, ascend910B2_normal_dtype_bfloat16_format_hwcn_dim_2_keepdim_true)
{
...
TEST_F(TestAclnnStd, normal_dtype_float32_format_ncdhw_dim_2_3_keepdim_true)
{
...
TEST_F(TestAclnnStd, normal_dtype_float16_format_ndhwc_dim_1_4_keepdim_true)
{
...
// 正常场景_correction为0
TEST_F(TestAclnnStd, normal_correction_0)
{
...
// 正常场景_correction为2
TEST_F(TestAclnnStd, normal_correction_2)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(TestAclnnStd, normal_all_reduce_keepdim_false)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(TestAclnnStd, normal_all_reduce_empty_dim_keepdim_false)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// 0维tensor场景
TEST_F(TestAclnnStd, normal_shape_dim_0)
{
...
// 8维tensor场景
TEST_F(TestAclnnStd, normal_shape_dim_8)
{
...
// dim为空指针
TEST_F(TestAclnnStd, normal_dim_nullptr)
{
...
TEST_F(TestAclnnStd, normal_neg_dim)
{
...
// 空tensor场景
TEST_F(TestAclnnStd, normal_empty_tensor)
{
...
TEST_F(TestAclnnStd, normal_shape_prod_equal_1_correction_equal)
{
...
TEST_F(TestAclnnStd, normal_shape_prod_equal_1_correction_above)
{
    auto selfDesc = TensorDesc({1, 2, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{0});
    int64_t correction = 2;
...
TEST_F(TestAclnnStd, normal_correction_greater_than_1_correction_equal)
{
    auto selfDesc = TensorDesc({1, 2, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(TestAclnnStd, normal_correction_greater_than_1_correction_above)
{
...
// CheckNotNull_1
TEST_F(TestAclnnStd, abnormal_self_nullptr)
{
    auto selfDesc = TensorDesc({2, 1, 9, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{2, 3});
    int64_t correction = 1;
...
// CheckNotNull_2
TEST_F(TestAclnnStd, abnormal_out_nullptr)
{
    auto selfDesc = TensorDesc({2, 1, 9, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{2, 3});
    int64_t correction = 1;
...
// CheckDtypeValid_1
TEST_F(TestAclnnStd, abnormal_dtype_int32)
{
...
// CheckDtypeValid_2
TEST_F(TestAclnnStd, abnormal_dtype_uint8)
{
...
// CheckDimValid_1
TEST_F(TestAclnnStd, abnormal_dim_out_of_range)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// CheckDimValid_2
TEST_F(TestAclnnStd, abnormal_dim_repeated)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// CheckDimValid_3
TEST_F(TestAclnnStd, abnormal_dim_neg_out_of_range)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// CheckDimValid_4
TEST_F(TestAclnnStd, abnormal_neg_dim_repeated)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// CheckShape_1
TEST_F(TestAclnnStd, abnormal_shape_dim_greater_than_threshold)
{
...
TEST_F(TestAclnnStd, l2_std_self_scalar_tensor)
{
...
TEST_F(TestAclnnStd, l2_std_self_scalar_tensor_keepdim)
{
    std::vector<float> selfHostData = {0.0};
    std::vector<int64_t> selfShape = {1};
    void* selfDeviceAddr = nullptr;
...
// 950
TEST_F(TestAclnnStd, ascend950_normal_dtype_float16_format_hwcn_dim_2_keepdim_true)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT16, ACL_FORMAT_HWCN).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{2});
    int64_t correction = 1;
...
// CheckShape_2: out shape 不匹配
TEST_F(TestAclnnStd, abnormal_shape_not_match)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{1});
    int64_t correction = 1;
...
// CheckShape_3: keepdim为true时out shape不匹配
TEST_F(TestAclnnStd, abnormal_shape_not_match_keepdim_true)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{1});
    int64_t correction = 1;
    bool keepdim = true;
    auto outDesc = TensorDesc({1, 1, 4}, ACL_FLOAT, ACL_FORMAT_ND);
...
// dim为负数场景
TEST_F(TestAclnnStd, normal_neg_dim_valid)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{-2});
    int64_t correction = 1;
...
// 负dim转换测试
TEST_F(TestAclnnStd, normal_neg_dim_convert)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{-1, -2, -3});
    int64_t correction = 1;
    bool keepdim = true;
...
TEST_F(TestAclnnStd, normal_correction_above_shape_prod)
{
    auto selfDesc = TensorDesc({1, 1, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{0, 1});
    int64_t correction = 3;
    bool keepdim = true;
    auto outDesc = TensorDesc({1, 1, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.0001, 0.0001);
...
// 混合正负dim
TEST_F(TestAclnnStd, normal_mixed_pos_neg_dim)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{1, -2});
    int64_t correction = 1;
...
// 5维tensor场景
TEST_F(TestAclnnStd, normal_shape_dim_5)
{
    auto selfDesc = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{0, 2, 4});
    int64_t correction = 1;
    bool keepdim = false;
...
// 测试最后一个维度
TEST_F(TestAclnnStd, normal_last_dim)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{3});
    int64_t correction = 1;
    bool keepdim = false;
    auto outDesc = TensorDesc({1, 2, 6}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.0001, 0.0001);
...
// 测试第一个维度
TEST_F(TestAclnnStd, normal_first_dim)
{
    auto selfDesc = TensorDesc({1, 2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{0});
    int64_t correction = 1;
    bool keepdim = false;
    auto outDesc = TensorDesc({2, 6, 4}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.0001, 0.0001);
...
// dtype float32
TEST_F(TestAclnnStd, normal_dtype_float32)
{
...
// dtype float16
TEST_F(TestAclnnStd, normal_dtype_float16)
{
    auto selfDesc = TensorDesc({2, 3, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto dimDesc = IntArrayDesc(vector<int64_t>{1});
    int64_t correction = 1;
    bool keepdim = false;
