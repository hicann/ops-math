...
class TestStdInfershape : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestStdInfershape SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestStdInfershape TearDown" << std::endl;
    }
};
    ...
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    gert::StorageShape meanStorageShape = {};
    std::vector<gert::StorageShape*> outputShapes = {&outStorageShape, &meanStorageShape};
...
TEST_F(TestStdInfershape, ReduceStdV2_infershape_case_0)
{
...
TEST_F(TestStdInfershape, ReduceStdV2_infershape_float32_keepdim_false)
{
    std::vector<gert::StorageShape> inputShapes = {{{2, 3, 4, 5}, {2, 3, 4, 5}}};
    std::vector<ge::DataType> dtypes = {ge::DT_FLOAT};
    std::vector<std::vector<int64_t>> expectResult = {{2, 4}, {2, 4}};
    gert::StorageShape outStorageShape = {};

    ExeTestCase(expectResult, inputShapes, dtypes, outStorageShape, {1, 3}, 1, false, true, ge::GRAPH_SUCCESS);
}

TEST_F(TestStdInfershape, ReduceStdV2_infershape_bf16_multi_dim_keepdim_true)
{
    std::vector<gert::StorageShape> inputShapes = {{{2, 3, 4, 5}, {2, 3, 4, 5}}};
    std::vector<ge::DataType> dtypes = {ge::DT_BF16};
    std::vector<std::vector<int64_t>> expectResult = {{2, 1, 4, 1}, {2, 1, 4, 1}};
    gert::StorageShape outStorageShape = {};

    ExeTestCase(expectResult, inputShapes, dtypes, outStorageShape, {1, 3}, 1, true, true, ge::GRAPH_SUCCESS);
}

TEST_F(TestStdInfershape, ReduceStdV2_infershape_negative_dim)
{
    std::vector<gert::StorageShape> inputShapes = {{{2, 3, 4, 5}, {2, 3, 4, 5}}};
    std::vector<ge::DataType> dtypes = {ge::DT_FLOAT16};
    std::vector<std::vector<int64_t>> expectResult = {{2, 3, 4}, {2, 3, 4}};
    gert::StorageShape outStorageShape = {};

    ExeTestCase(expectResult, inputShapes, dtypes, outStorageShape, {-1}, 1, false, true, ge::GRAPH_SUCCESS);
}

TEST_F(TestStdInfershape, ReduceStdV2_infershape_scalar_empty_dim)
{
    ...
    ExeTestCase(expectResult, inputShapes, dtypes, outStorageShape, {}, 0, false, true, ge::GRAPH_SUCCESS);
}

TEST_F(TestStdInfershape, ReduceStdV2_infershape_invalid_dim)
{
    std::vector<gert::StorageShape> inputShapes = {{{2, 3, 4}, {2, 3, 4}}};
    std::vector<ge::DataType> dtypes = {ge::DT_FLOAT};
    std::vector<std::vector<int64_t>> expectResult = {};
    gert::StorageShape outStorageShape = {};

    ExeTestCase(expectResult, inputShapes, dtypes, outStorageShape, {3}, 1, false, true, ge::GRAPH_FAILED);
}
