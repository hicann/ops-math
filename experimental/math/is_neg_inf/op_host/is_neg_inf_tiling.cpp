...
static graphStatus ValidateInput(
    gert::TilingContext* context, int64_t& totalLength, int64_t& dtypeSize, IsNegInfDtypeId& dtypeId)
{
...
static graphStatus TilingParseForIsNegInf([[maybe_unused]] gert::TilingParseContext* context)
{
    return GRAPH_SUCCESS;
}
