...
#ifndef OPS_BUILD_IN_OP_TILING_RUNTIME_IS_NEG_INF_TILING_H
#define OPS_BUILD_IN_OP_TILING_RUNTIME_IS_NEG_INF_TILING_H

#include "register/tilingdata_base.h"

namespace optiling {

BEGIN_TILING_DATA_DEF(IsNegInfTilingData)
...
REGISTER_TILING_DATA_CLASS(IsNegInf, IsNegInfTilingData)
