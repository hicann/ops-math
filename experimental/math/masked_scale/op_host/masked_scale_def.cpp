...
public:
    const std::vector<ge::DataType> xDataType = {ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
                                                 ge::DT_FLOAT,   ge::DT_FLOAT,   ge::DT_FLOAT,   ge::DT_FLOAT,
                                                 ge::DT_BF16,    ge::DT_BF16,    ge::DT_BF16,    ge::DT_BF16};
    const std::vector<ge::DataType> maskDataType = {ge::DT_UINT8, ge::DT_INT8, ge::DT_FLOAT16, ge::DT_FLOAT,
                                                    ge::DT_UINT8, ge::DT_INT8, ge::DT_FLOAT16, ge::DT_FLOAT,
                                                    ge::DT_UINT8, ge::DT_INT8, ge::DT_FLOAT16, ge::DT_FLOAT};
    ...
    explicit MaskedScale(const char* name) : OpDef(name)
    {
        ...
        auto BuildAiCoreConfig = []() {
            ...
            config.ExtendCfgInfo("opFile.value", "masked_scale_apt");
            return config;
        };
        auto ascend910bConfig = BuildAiCoreConfig();
        auto ascend950Config = BuildAiCoreConfig();
        this->AICore().AddConfig("ascend910b", ascend910bConfig);
