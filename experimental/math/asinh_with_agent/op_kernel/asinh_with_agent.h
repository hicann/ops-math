...
#include "asinh_with_agent_tiling_data.h"
#include "asinh_with_agent_tiling_key.h"
...
class AsinhWithAgent {
    static constexpr int32_t BUFFER_NUM = BUFFER_MODE ? 2 : 1;

public:
    __aicore__ inline AsinhWithAgent() {}

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, const AsinhWithAgentTilingData* td);
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void AsinhWithAgent<T, BUFFER_MODE>::CopyIn(int64_t progress, int64_t currentNum)
{
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void AsinhWithAgent<T, BUFFER_MODE>::CopyOut(int64_t progress, int64_t currentNum)
{
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void AsinhWithAgent<T, BUFFER_MODE>::Process()
{
