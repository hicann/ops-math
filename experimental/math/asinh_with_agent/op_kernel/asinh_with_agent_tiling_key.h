 ...
 * \brief AsinhWithAgent TilingKey 模板参数定义（arch22）
 *
 * 模板参数：
...
ASCENDC_TPL_ARGS_DECL(AsinhWithAgent, ASCENDC_TPL_DATATYPE_DECL(D_T_X, C_DT_FLOAT, C_DT_FLOAT16, ASCENDC_TPL_INPUT(0)),
