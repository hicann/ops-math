...
/*!
 * \file reduce_mean_v2_tiling_key.h
 * \brief reduce mean v2 tiling key declare
*/

#ifndef _REDUCE_MEAN_V2_TILING_KEY_H__
#define _REDUCE_MEAN_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(ReduceMeanV2,
