...
/*!
 * \file reduce_mean_v2_infershape.cpp
 * \brief
 */
...
static ge::graphStatus InferShapeReduceMeanV2(gert::InferShapeContext* context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do InferShapeReduceMeanV2");
...
IMPL_OP_INFERSHAPE(ReduceMeanV2).InferShape(InferShapeReduceMeanV2);
} // namespace ops