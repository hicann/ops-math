...
/*!
 * \file complex_v3_def.cpp
 * \brief ComplexV3 operator definition - declares inputs, outputs, and operator configuration
 */
#include "register/op_def_registry.h"

namespace ops {
class ComplexV3 : public OpDef {
public:
    explicit ComplexV3(const char* name) : OpDef(name)
    {
        this->Input("real")
            .ParamType(REQUIRED)
        ...
        this->Output("out")
            .ParamType(REQUIRED)
            .DataType({ge::DT_COMPLEX64, ge::DT_COMPLEX32})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
