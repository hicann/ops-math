 ...
 * \brief AsinWithAgent 模板参数定义（arch22）
 *
...
ASCENDC_TPL_ARGS_DECL(AsinWithAgent,
                      ASCENDC_TPL_DATATYPE_DECL(D_T, C_DT_FLOAT, C_DT_FLOAT16, C_DT_DOUBLE, C_DT_INT8, C_DT_INT16,
                                                C_DT_INT32, C_DT_INT64, C_DT_UINT8, C_DT_BOOL, ASCENDC_TPL_INPUT(0)), );
