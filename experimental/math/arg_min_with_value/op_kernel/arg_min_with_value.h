 ...
 */
#ifndef ARG_MIN_WITH_VALUE_H
#define ARG_MIN_WITH_VALUE_H

#include "arg_min_with_value_tiling_data.h"
#include "arg_min_with_value_tiling_key.h" // visible to kernel codegen so the per-schMode binaries are emitted
#include "arg_min_with_value_base.h"
#include "arg_min_with_value_copy.h"
#include "arg_min_with_value_last.h"
#include "arg_min_with_value_nlast.h"
#include "arg_min_with_value_small_last.h"
