...
/*!
 * \file test_arg_min_with_value_infershape.cpp
 * \brief ArgMinWithValue infer-shape unit tests.
 */
...
class ArgMinWithValue : public testing::Test {};
                        ...
                        ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    auto inferShapeFunc = spaceRegistry->GetOpImpl("ArgMinWithValue")->infer_shape;
...
TEST_F(ArgMinWithValue, ArgMinWithValue_infershape_keepdim_false)
{
...
TEST_F(ArgMinWithValue, ArgMinWithValue_infershape_keepdim_true)
{
    gert::StorageShape xShape = {{2, 100, 4}, {2, 100, 4}};
    gert::StorageShape indiceShape = {};
    gert::StorageShape valueShape = {};
...
TEST_F(ArgMinWithValue, ArgMinWithValue_infershape_negative_dim)
{
