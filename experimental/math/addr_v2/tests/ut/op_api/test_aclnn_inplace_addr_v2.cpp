...
class l2_inplace_addr_v2_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "inplace_addr_v2_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "inplace_addr_v2_test TearDown" << endl; }
};

// *** tensor rank range ***
// self dims is not 2 for inplaceAddrV2
TEST_F(l2_inplace_addr_v2_test, case_inplace_addr_v2_for_self_dims_not_two)
{
...
TEST_F(l2_inplace_addr_v2_test, case_inplace_addr_v2_for_self_unequal_shape)
{
