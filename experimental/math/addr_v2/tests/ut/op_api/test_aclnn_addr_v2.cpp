...
#include "../../../op_api/aclnn_addr_v2.h"
...
class l2_addr_v2_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "addr_v2_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "addr_v2_test TearDown" << endl; }
};

// *** tensor dtype test ***
// test dtype: FLOAT16
TEST_F(l2_addr_v2_test, case_addr_v2_for_float16_type)
{
    ...
    auto ut = OP_API_UT(
        aclnnAddrV2, INPUT(self_tensor_desc, vec1_tensor_desc, vec2_tensor_desc, beta_scalar_desc, alpha_scalar_desc),
...
// test dtype: BFLOAT16
TEST_F(l2_addr_v2_test, ascend910B2_addr_v2_dtype_bfloat16)
{
...
TEST_F(l2_addr_v2_test, ascend950_addr_v2_dtype_bfloat16)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_float_type)
{
...
// test dtype: INT8
TEST_F(l2_addr_v2_test, case_addr_v2_for_int8_type)
{
...
// test dtype: INT32
TEST_F(l2_addr_v2_test, case_addr_v2_for_int32_type)
{
...
// test dtype: INT64
TEST_F(l2_addr_v2_test, case_addr_v2_for_int64_type)
{
...
// test dtype: UINT8
TEST_F(l2_addr_v2_test, case_addr_v2_for_uint8_type)
{
    // UINT8 是无符号整数类型（值域 0–255），ValueRange 必须使用非负范围以匹配值域
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_UINT8, ACL_FORMAT_ND).ValueRange(0, 10);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_UINT8, ACL_FORMAT_ND).ValueRange(0, 10);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_UINT8, ACL_FORMAT_ND).ValueRange(0, 10);
...
// test dtype: BOOL
TEST_F(l2_addr_v2_test, case_addr_v2_for_bool_type)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_invalid_complex_type)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_bool_scalar_without_bool_input)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_floating_scalar_under_int_input)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-10, 10);
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_left_vec_is_empty_tensor)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_right_vec_is_empty_tensor)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_vec_isnot_1d_tensor)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
...
// self dims is over 2
TEST_F(l2_addr_v2_test, case_addr_v2_for_self_dims_over_two)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_unable_broadcast_within_self_vec12)
{
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_vec_dtype_cast)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
...
// *** nullptr test ***
// test nullptr input
TEST_F(l2_addr_v2_test, case_addr_v2_for_nullptr_input)
{
    auto vec1_tensor_desc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto beta_scalar_desc = ScalarDesc(1.0f);
...
// test nullptr vec
TEST_F(l2_addr_v2_test, case_addr_v2_for_nullptr_vec)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto beta_scalar_desc = ScalarDesc(1.0f);
...
// test nullptr output
TEST_F(l2_addr_v2_test, case_addr_v2_for_nullptr_output)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
...
TEST_F(l2_addr_v2_test, case_addr_v2_for_nullptr_scalar)
{
    auto self_tensor_desc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
    auto vec1_tensor_desc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
    auto vec2_tensor_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2.0, 2.0);
