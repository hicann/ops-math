...
<table style="table-layout: fixed; width: 980px"><colgroup>
  ...
  - Atlas A2 训练系列产品/Atlas A2 推理系列产品：数据类型支持FLOAT、FLOAT16、DOUBLE、INT8、INT16、INT32、INT64、UINT8、BOOL、BFLOAT16。
...
| 调用方式 | 调用样例                                                                   | 说明                                                           |
|--------------|------------------------------------------------------------------------|--------------------------------------------------------------|
| aclnn调用 | [test_aclnn_addr_v2](./examples/test_aclnn_addr_v2.cpp) | 通过[aclnnAddrV2](docs/aclnnAddrV2&aclnnInplaceAddrV2.md)/[aclnnInplaceAddrV2](docs/aclnnAddrV2&aclnnInplaceAddrV2.md)接口方式调用AddrV2算子。 |
