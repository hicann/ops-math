...
static ge::graphStatus InferShape4AddrV2(gert::InferShapeContext* context)
{
    OP_LOGD(context->GetNodeName(), "InferShape4AddrV2 enter");
...
IMPL_OP_INFERSHAPE(AddrV2).InferShape(InferShape4AddrV2);
} // namespace ops
