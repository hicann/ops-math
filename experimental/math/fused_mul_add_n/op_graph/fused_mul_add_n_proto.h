...
/**
* @brief Fused element-wise scalar-multiply-add. Computes y = x1 * x3[0] + x2,
* where x3 is a single-element scalar tensor (only x3[0] participates).

* @par Inputs:
* Three inputs, including:
* @li x1: A ND tensor. Must be one of the following types:int32, int16,
* bfloat16, float16, float32. x1 is the main tensor multiplied by the scalar x3[0]. \n
* @li x2: A ND tensor of the same dtype and shape as "x1". x2 is added element-wise
* to the product x1 * x3[0]. \n
* @li x3: A ND tensor of the same dtype as "x1". The shape size should be 1.
* Its first element x3[0] is used as the scalar multiplier for x1. \n
