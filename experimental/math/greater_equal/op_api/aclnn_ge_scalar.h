 ...
 * @domain aclnn_math
 * @param [in] selfRef: npu device侧的aclTensor，与 out 复用同一缓冲。
 * @param [in] other: aclScalar，语义同 aclnnGeScalar 的 other。
 ...
 */
ACLNN_API aclnnStatus
aclnnInplaceGeScalar(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
