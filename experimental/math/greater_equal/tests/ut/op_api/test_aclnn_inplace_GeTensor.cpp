...
#include "../../../op_api/aclnn_ge_tensor.h"
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_int8)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_input_float)
{
    auto tensor_self =
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_double)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_int64)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_int32)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_int16)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_out_float16)
{
    auto tensor_self =
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_input_bool)
{
    auto tensor_self =
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_normal_bool_to_float)
{
...
// 入参为self为null场景
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_self_is_null)
{
...
// 入参为other为null场景
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_other_is_null)
{
    auto tensor_self =
        TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10).Value(vector<float>{3, 4, 5, 6, 7, 8});
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_input_is_empty)
{
...
// 入参self数据类型不支持的场景
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_self_dtype_invalid)
{
...
// 入参oter数据类型不支持的场景
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_other_dtype_invalid)
{
...
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_input_shape_greater_than_8)
{
...
// 入参无法broadcast的场景
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_input_cannot_broadcast)
{
...
// complex64 不支持
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_not_support_complex64)
{
    auto tensor_self =
...
// 非连续
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_to_contiguous)
{
    auto tensor_self =
...
// 数据范围[-1,1]
TEST_F(test_aclnn_inplace_GeTensor, test_inplace_ge_tensor_date_range_f1_1)
{
    auto tensor_self =
