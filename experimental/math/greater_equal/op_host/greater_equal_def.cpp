...
public:
    explicit GreaterEqual(const char* name) : OpDef(name)
    {
        static const std::vector<ge::DataType> inputDataType = {
            ge::DT_BF16,  ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_UINT32, ge::DT_UINT16,
            ge::DT_INT16, ge::DT_UINT8,   ge::DT_INT8,  ge::DT_INT64, ge::DT_UINT64, ge::DT_BOOL};
        static const std::vector<ge::DataType> outputDataType(inputDataType.size(), ge::DT_BOOL);
        static const std::vector<ge::Format> format(inputDataType.size(), ge::FORMAT_ND);
