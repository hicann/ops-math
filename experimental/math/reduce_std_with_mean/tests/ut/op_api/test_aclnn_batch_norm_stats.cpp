...
#include "experimental/math/reduce_std_with_mean/op_api/aclnn_batch_norm_stats_experimental.h"
...
protected:
    static void SetUpTestCase() { cout << "l2_batch_norm_stats_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "l2_batch_norm_stats_test TearDown" << endl; }
};
