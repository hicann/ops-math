...
class AsinGradTiling : public testing::Test {};

TEST_F(AsinGradTiling, asin_grad_tiling_fp32)
{
    struct AsinGradCompileInfo {
    } compileInfo;
    gert::TilingContextPara tilingContextPara("AsinGrad",
                                              {
    ...
    std::string expectTilingData = "0 1024 64 7016 0 ";
