...
static bool CheckPromoteType(const aclTensor* input, const aclTensor* shiftBits, const aclTensor* out,
...
aclnnStatus aclnnRightShiftGetWorkspaceSize(const aclTensor* input, const aclTensor* shiftBits, aclTensor* out,
...
aclnnStatus aclnnRightShift(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream)
{
