...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    // dtype校验
    const std::set<ge::DataType> supportedDtype = {ge::DT_FLOAT,   ge::DT_INT32, ge::DT_INT16,
...
static ge::graphStatus MaximumV2TilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_NULL_WITH_CONTEXT(context, tiling);
    OP_CHECK_IF(
        memset_s(tiling, sizeof(MaximumV2TilingData), 0, sizeof(MaximumV2TilingData)) != EOK,
