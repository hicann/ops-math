...
#include "../../../op_api/aclnn_is_pos_inf.h"
...
protected:
    ...
    {
        std::cout << "is_pos_inf_test SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "is_pos_inf_test TearDown" << std::endl;
    }
};

TEST_F(l2_is_pos_inf_test, case_support_float32)
{
    auto selfDesc =
...
TEST_F(l2_is_pos_inf_test, case_support_float16)
{
...
TEST_F(l2_is_pos_inf_test, case_support_bf16)
{
...
TEST_F(l2_is_pos_inf_test, case_support_integer_all_false)
{
...
TEST_F(l2_is_pos_inf_test, case_support_bool_all_false)
{
...
TEST_F(l2_is_pos_inf_test, case_non_contiguous_input_output)
{
...
TEST_F(l2_is_pos_inf_test, case_null_self)
{
    auto outDesc = TensorDesc({2, 3}, ACL_BOOL, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnIsPosInf, INPUT(nullptr), OUTPUT(outDesc));
...
TEST_F(l2_is_pos_inf_test, case_null_out)
{
    auto selfDesc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto ut = OP_API_UT(aclnnIsPosInf, INPUT(selfDesc), OUTPUT(nullptr));
...
TEST_F(l2_is_pos_inf_test, case_shape_mismatch)
{
    auto selfDesc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_is_pos_inf_test, case_out_dtype_invalid)
{
    auto selfDesc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_is_pos_inf_test, case_complex_invalid)
{
...
TEST_F(l2_is_pos_inf_test, case_rank_too_large)
{
...
TEST_F(l2_is_pos_inf_test, case_empty_tensor)
{
