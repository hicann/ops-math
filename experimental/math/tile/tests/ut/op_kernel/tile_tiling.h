...
#ifndef _TILE_TILING_H_
#define _TILE_TILING_H_

#include <cstdint>
#include "../../../op_kernel/tile_tiling_data.h"
#include "kernel_tiling/kernel_tiling.h"
#include "../../../op_kernel/tile.h"
...
#else
inline void InitTilingData(uint8_t* tiling, TileTilingData* constData)
{
    memcpy(constData, tiling, sizeof(TileTilingData));
}
#endif
