...
#include <vector>
#include "acl/acl.h"
#include "aclnnop/level2/aclnn_repeat.h"
...
int main()
{
    ...
    aclIntArray* repeats = aclCreateIntArray(repeatsData.data(), repeatsData.size());
    ...
    LOG_PRINT("aclnnRepeat (Tile) result:\n");
    for (int64_t i = 0; i < outShape[0]; i++) {
        for (int64_t j = 0; j < outShape[1]; j++) {
            LOG_PRINT("%6.1f ", resultData[i * outShape[1] + j]);
        }
        LOG_PRINT("\n");
    }
