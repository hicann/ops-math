...
static const std::initializer_list<op::DataType> DTYPE_SUPPORT_LIST = {
    op::DataType::DT_FLOAT, op::DataType::DT_FLOAT16, op::DataType::DT_COMPLEX64, op::DataType::DT_UINT8,
    op::DataType::DT_INT8,  op::DataType::DT_INT16,   op::DataType::DT_INT32,     op::DataType::DT_BOOL,
    op::DataType::DT_BF16,  op::DataType::DT_UINT32,  op::DataType::DT_UINT64};

static const std::initializer_list<op::DataType> DTYPE_SUPPORT_910B310P_LIST = {
    op::DataType::DT_FLOAT, op::DataType::DT_FLOAT16, op::DataType::DT_COMPLEX64, op::DataType::DT_UINT8,
    op::DataType::DT_INT8,  op::DataType::DT_INT16,   op::DataType::DT_INT32,     op::DataType::DT_BOOL,
    op::DataType::DT_BF16,  op::DataType::DT_UINT32,  op::DataType::DT_UINT64,    op::DataType::DT_UINT16};
