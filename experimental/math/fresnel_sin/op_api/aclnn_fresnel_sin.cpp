...
static bool CheckDtypeValid(const aclTensor* x, const aclTensor* out)
{
    ...
    OP_CHECK(
        ...
        OP_LOGE(
            ACLNN_ERR_PARAM_INVALID, "FresnelSin dtype not supported: %d. Only FLOAT, FLOAT16, BFLOAT16.",
...
static bool CheckShape(const aclTensor* x, const aclTensor* out)
{
    ...
    OP_CHECK(
        ...
        OP_LOGE(ACLNN_ERR_PARAM_INVALID, "FresnelSin: x and out shape must match."), return false);
    return true;
}
