...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    // dtype校验
    const std::set<ge::DataType> supportedDtype = {ge::DT_FLOAT, ge::DT_INT32, ge::DT_INT64, ge::DT_FLOAT16,
                                                   ge::DT_INT16, ge::DT_BF16,  ge::DT_INT8,  ge::DT_UINT8};
...
static ge::graphStatus CastV2TilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(
        memset_s(tiling, sizeof(CastV2TilingData), 0, sizeof(CastV2TilingData)) != EOK,
    ...
    // 此处，ubDataNumber根据输入输出的数据类型字长确定，例如：x为int16，z为half，则ubDataNumber = 1 +
    // sizeof(z)/sizeof(x) = 2,如果不能整除，则额外加1
