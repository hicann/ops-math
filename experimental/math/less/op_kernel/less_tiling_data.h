...
/*!
 * \file less_tiling_data.h
 * \brief tiling data struct
 */

#ifndef __LESS_TILLING_DATA_H__
#define __LESS_TILLING_DATA_H__

struct LessTilingData {
    ...
    uint32_t isTailBlock;
    uint32_t bigprocessDataNumComputes;
    uint32_t smallprocessDataNumComputes;
    uint32_t tailbigprocessDataNumComputes;
