...
ASCENDC_TPL_ARGS_DECL(
    FresnelCos, ASCENDC_TPL_UINT_DECL(
                    schMode, 8, ASCENDC_TPL_UI_LIST, FRESNEL_COS_KEY_FP32, FRESNEL_COS_KEY_FP16, FRESNEL_COS_KEY_BF16));

ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(
        schMode, ASCENDC_TPL_UI_LIST, FRESNEL_COS_KEY_FP32, FRESNEL_COS_KEY_FP16, FRESNEL_COS_KEY_BF16)), );
