...
static ge::graphStatus InferShapeRealDiv(gert::InferShapeContext* context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do InferShapeRealDiv");
    ...
    // 填充输出shape大小
    *outShape = *selfShape;
    OP_LOGD(context->GetNodeName(), "End to do InferShapeRealDiv");
