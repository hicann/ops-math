...
#include <vector>
#include "acl/acl.h"
#include "aclnn_reduce_prod_v2.h"
...
int main()
{
    ...
    ret = aclnnReduceProdV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnReduceProdV2 failed. ERROR: %d\n", ret); return ret);
