...
template <typename T>
__aicore__ inline void ReduceProdV2<T>::Init(GM_ADDR x, GM_ADDR z,GM_ADDR workspace, const ReduceProdV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void ReduceProdV2<T>::CopyIn(int32_t progress)
{
