...
/*!
 * \file reduce_prod_v2_tiling_key.h
 * \brief reduce prod v2 tiling key declare
*/

#ifndef _REDUCE_PROD_V2_TILING_KEY_H__
#define _REDUCE_PROD_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(ReduceProdV2,
