...
/*!
 * \file add_mat_mat_elements_plus_tiling_arch32.cpp
 * \brief AddMatMatElementsPlus Tiling 实现（arch32，Ascend910B / Ascend910_93）
 *
 * 与 arch35 的差异：增大 tileLength，充分利用 arch32（DAV_2201）的 192KB UB。
 ...
 *
 * kernel 源码使用独立的 arch32 实现（op_kernel/arch32/），与 arch35 解耦。
 */
...
#include "../../op_kernel/arch32/add_mat_mat_elements_plus_tiling_key_arch32.h"
...
// arch32 优化 tileLength（充分利用 192KB UB）
