...
__golden__ = {
    "kernel": {"add_mat_mat_elements_plus": "add_mat_mat_elements_plus_golden"}
}


def add_mat_mat_elements_plus_golden(c, a, b, beta, alpha, **kwargs):
    """
    Kernel golden for add_mat_mat_elements_plus.
