...
#include "../../../../op_host/arch35/add_mat_mat_elements_plus_tiling_arch35.h"
...
class AddMatMatElementsPlusTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "AddMatMatElementsPlusTilingTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddMatMatElementsPlusTilingTest TearDown" << std::endl; }
};

TEST_F(AddMatMatElementsPlusTilingTest, add_mat_mat_elements_plus_tiling_fp32_basic)
{
    gert::StorageShape shape = {{32, 32}, {32, 32}};
    gert::StorageShape scalarShape = {{1}, {1}};

    AddMatMatElementsPlusCompileInfo compileInfo;

    gert::TilingContextPara tilingContextPara("AddMatMatElementsPlus",
...
TEST_F(AddMatMatElementsPlusTilingTest, add_mat_mat_elements_plus_tiling_fp16_basic)
{
...
TEST_F(AddMatMatElementsPlusTilingTest, add_mat_mat_elements_plus_tiling_bf16_basic)
{
...
TEST_F(AddMatMatElementsPlusTilingTest, add_mat_mat_elements_plus_tiling_fp32_large)
{
