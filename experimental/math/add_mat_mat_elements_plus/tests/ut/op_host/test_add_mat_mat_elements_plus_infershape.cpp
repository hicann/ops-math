...
class AddMatMatElementsPlusInfershapeTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "AddMatMatElementsPlusInfershapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddMatMatElementsPlusInfershapeTest TearDown" << std::endl; }
};

TEST_F(AddMatMatElementsPlusInfershapeTest, add_mat_mat_elements_plus_infershape_same_shape)
{
    gert::StorageShape shape = {{4, 8}, {4, 8}};
    gert::StorageShape scalarShape = {{1}, {1}};

    gert::InfershapeContextPara infershapeContextPara("AddMatMatElementsPlus",
...
TEST_F(AddMatMatElementsPlusInfershapeTest, add_mat_mat_elements_plus_infershape_broadcast_a)
{
...
TEST_F(AddMatMatElementsPlusInfershapeTest, add_mat_mat_elements_plus_infershape_broadcast_b)
{
...
TEST_F(AddMatMatElementsPlusInfershapeTest, add_mat_mat_elements_plus_infershape_3d)
{
...
TEST_F(AddMatMatElementsPlusInfershapeTest, add_mat_mat_elements_plus_infershape_broadcast_diff_rank)
{
    // a: [8], b: [4, 8], c: [4, 8] -> [4, 8]
