 ...
 * \brief AddMatMatElementsPlus TilingData 结构体定义
 *
 * 使用标准 C++ struct，禁止使用废弃宏 BEGIN_TILING_DATA_DEF
 *
 * 注意：alpha/beta 现在作为 tensor input（与 proto.h 一致），由 kernel 从 GM 读取，
 *       不再放在 TilingData 中。
 */

#ifndef ADD_MAT_MAT_ELEMENTS_PLUS_TILING_DATA_H_
#define ADD_MAT_MAT_ELEMENTS_PLUS_TILING_DATA_H_

struct AddMatMatElementsPlusTilingData {
...
#endif // ADD_MAT_MAT_ELEMENTS_PLUS_TILING_DATA_H_
