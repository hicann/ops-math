 ...
 * \brief AddMatMatElementsPlus TilingKey 模板参数定义
 *
...
#ifndef ADD_MAT_MAT_ELEMENTS_PLUS_TILING_KEY_H_
#define ADD_MAT_MAT_ELEMENTS_PLUS_TILING_KEY_H_

#ifndef __CCE_KT_TEST__
#include "ascendc/host_api/tiling/template_argument.h"

// 声明模板参数：D_T 从输入 tensor 0 的 dtype 中选取
ASCENDC_TPL_ARGS_DECL(AddMatMatElementsPlus,
...
#endif // ADD_MAT_MAT_ELEMENTS_PLUS_TILING_KEY_H_
