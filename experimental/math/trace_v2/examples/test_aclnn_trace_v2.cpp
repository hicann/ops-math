...
int main()
{
    ...
    std::vector<DataType> outHostData(1, 0);
    ...
    // 5. 调用aclnnTraceV2第二段接口
    ret = aclnnTraceV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnTraceV2 failed. ERROR: %d\n", ret); return ret);
    ...
    std::vector<int64_t> outShape1 = {1};
