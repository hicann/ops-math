 ...
 * @domain aclnn_math
 * 计算self中的元素的值与other的值是否相等，
 * 将self每个元素与other的值的比较结果写入out中：
 *
 ...
 * 数据类型支持FLOAT16, FLOAT, INT64, UINT64, INT32, INT8, UINT8, BOOL, UINT32, BFLOAT16, DOUBLE,
 * INT16, COMPLEX64,
 * COMPLEX128，数据格式支持ND，支持非连续的Tensor。
 * @param [in] other: host侧的aclScalar，
 * 数据类型支持FLOAT16, FLOAT, INT64, UINT64, INT32, INT8, UINT8, BOOL, UINT32,
 ...
 * 由第一段接口aclnnEqScalarGetWorkspaceSize获取。
 ...
 * @domain aclnn_math
 * 计算self中的元素的值与other的值是否相等，
 * 将self每个元素与other的值的比较结果原地返回到self中：
 *
