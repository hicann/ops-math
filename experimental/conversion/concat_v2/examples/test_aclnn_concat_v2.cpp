...
int main()
{
    ...
    std::vector<int64_t> selfXShape = {2, 2, 3, 2};
    ...
    std::vector<int64_t> selfYShape = {2, 2, 3, 2};
    ...
    std::vector<int64_t> outShape = {1, 1, 3, 8};
    ...
    ret = aclnnConcatV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnConcatExample failed. ERROR: %d\n", ret); return ret);
    ...
    std::vector<int64_t> outShape1 = {24};
