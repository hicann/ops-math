...
/*!
 * \file concat_v2_tiling_key.h
 * \brief concat_v2 tiling key declare
 * */
#ifndef __CONCATV2_TILING_KEY_H__
#define __CONCATV2_TILING_KEY_H__
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(
        schMode, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0, ELEMENTWISE_TPL_SCH_MODE_1, )), );
