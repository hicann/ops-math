...
#include "../op_kernel/clip_by_value_v2_tiling_data.h"
#include "../op_kernel/clip_by_value_v2_tiling_key.h"
...
// tiling 分发入口
static ge::graphStatus ClipByValueV2TilingFunc(gert::TilingContext* context)
{
    ClipByValueV2TilingData* tiling = context->GetTilingData<ClipByValueV2TilingData>();
...
static ge::graphStatus TilingParseForClipByValueV2([[maybe_unused]] gert::TilingParseContext* context)
{
    return ge::GRAPH_SUCCESS;
}

// tiling注册入口.
IMPL_OP_OPTILING(ClipByValueV2).Tiling(ClipByValueV2TilingFunc).TilingParse<ClipByValueV2CompileInfo>(TilingParseForClipByValueV2);
} // namespace optiling
