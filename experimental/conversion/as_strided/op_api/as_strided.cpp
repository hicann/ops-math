...
const aclTensor* AsStridedAiCore(const aclTensor* x, const aclTensor* y, const aclTensor* size, const aclTensor* stride,
                                 const aclTensor* storageOffset, aclOpExecutor* executor)
{
    ...
    OP_CHECK(ret == ACLNN_SUCCESS,
             OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "AsStridedAiCore ADD_TO_LAUNCHER_LIST_AICORE failed."), return nullptr);
    return y;
}

const aclTensor* AsStrided(const aclTensor* x, const aclTensor* y, const aclTensor* size, const aclTensor* stride,
                           const aclTensor* storageOffset, aclOpExecutor* executor)
{
    ...
    auto dstSize = executor->ConvertToTensor(op::ToShapeVector(dstShape).data(), dstShape.GetDimNum(),
...
const aclTensor* AsStrided(aclTensor* x, const aclIntArray* size, const aclIntArray* stride,
                           const aclIntArray* storageOffset, aclOpExecutor* executor)
{
