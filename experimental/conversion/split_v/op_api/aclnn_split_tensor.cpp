...
static const std::initializer_list<DataType> DTYPE_SUPPORT_LIST = {
    DataType::DT_DOUBLE, DataType::DT_FLOAT,  DataType::DT_FLOAT16, DataType::DT_BF16,       DataType::DT_UINT64,
    DataType::DT_UINT32, DataType::DT_UINT16, DataType::DT_INT64,   DataType::DT_INT32,      DataType::DT_INT16,
                                             ...
                                             aclTensorList* out, uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    if (dimSize == static_cast<int64_t>(splitSections)) {
        ...
        if (l0op::SplitVAiCoreSupport(selfContiguous) && splitSize->Size() > SPLIT_LOOP_SIZE && !IsRegBase()) {
