...
class RandomStandardNormalV2KernelTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "RandomStandardNormalV2KernelTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "RandomStandardNormalV2KernelTest TearDown" << std::endl;
    }
};

TEST_F(RandomStandardNormalV2KernelTest, smoke_float)
{
    ...
    auto* count = static_cast<uint8_t*>(AscendC::GmAlloc(Align32(sizeof(int64_t))));
    ...
    std::memset(count, 0, sizeof(int64_t));
    ...
    ICPU_RUN_KF(random_standard_normal_v2, kNumBlocks, shape, offset, y, count, workspace, tiling);
