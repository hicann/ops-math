 ...
 */
 ...
 /*!
 * \file test_aclnn_stateless_uniform.cpp
 * \brief
 */
...
int main() {
  ...
  // aclnnInplaceUniform接口调用示例
  // 4. 调用aclnnInplaceUniform第一段接口
  ret = aclnnInplaceUniformGetWorkspaceSize(self, from, to, seed, offset, &workspaceSize, &executor);
  ...
  LOG_PRINT("StatelessUniform result (first 10 values, range [%.1f, %.1f]):\n", from, to);
