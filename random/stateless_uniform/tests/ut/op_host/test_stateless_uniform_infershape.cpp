...
/*!
 * \file test_stateless_uniform_infershape.cpp
 * \brief StatelessUniform InferShape UT
 *
 * 被测实现：op_host/stateless_uniform_infershape.cpp
 ...
 *
 * 注意：StatelessUniform 的 op_def 只声明 shape 为 DT_INT64，但 infershape 复用的公共基类
 * 对 INT32 也有分支，这里一并覆盖，保证 DependencyMode 的两条 dtype 路径都被走到。
 *
 ...
 *   [3] from:   DT_DOUBLE scalar
 *   [4] to:     DT_DOUBLE scalar
...
class StatelessUniformInferShapeTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "StatelessUniformInferShapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "StatelessUniformInferShapeTest TearDown" << std::endl; }
};

// case 1: 1D 输出。shape tensor = [16384]，1 个元素 → 输出 rank 1
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_1d)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_2d)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_4d)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_dim_with_one)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_fp16)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_bf16)
{
    vector<int64_t> shapeValue = {32, 512};
    gert::InfershapeContextPara infershapeContextPara(
        "StatelessUniform",
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_int32_shape)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_null_const_1d)
{
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_null_const_2d)
{
    vector<int64_t> shapeValue = {};
    gert::InfershapeContextPara infershapeContextPara(
        "StatelessUniform",
...
TEST_F(StatelessUniformInferShapeTest, stateless_uniform_infershape_case_invalid_shape_dtype)
{
