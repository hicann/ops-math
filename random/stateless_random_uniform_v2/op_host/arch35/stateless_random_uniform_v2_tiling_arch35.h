...
class StatelessRandomUniformV2Tiling : public Ops::Base::TilingBaseClass {
public:
    explicit StatelessRandomUniformV2Tiling(gert::TilingContext* context) : Ops::Base::TilingBaseClass(context)
    {}
