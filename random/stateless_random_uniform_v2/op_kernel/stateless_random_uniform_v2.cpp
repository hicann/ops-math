...
extern "C" __global__ __aicore__ void stateless_random_uniform_v2(GM_ADDR shape, GM_ADDR key, GM_ADDR counter,
                                                  GM_ADDR alg, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling) {
