...
#ifndef MATH_DROP_OUT_V3_FUSION_PASS_H
#define MATH_DROP_OUT_V3_FUSION_PASS_H
...
class __attribute__((visibility("default"))) DropOutV3FusionPass : public PatternFusionPass {
protected:
...
#endif // MATH_DROP_OUT_V3_FUSION_PASS_H