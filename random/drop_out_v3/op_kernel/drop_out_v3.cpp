...
#include "arch35/drop_out_v3_simd_impl.h"

using namespace DropOutV3;

#define DROP_OUT_V3_DEFAULT_TILING_KEY 100

__global__ __aicore__ void drop_out_v3(GM_ADDR x, GM_ADDR noiseShape, GM_ADDR p, GM_ADDR seed, GM_ADDR offset,
                                       GM_ADDR y, GM_ADDR mask, GM_ADDR workspace, GM_ADDR tiling)
{
    REGISTER_TILING_DEFAULT(DropOutV3TilingDataStruct);
