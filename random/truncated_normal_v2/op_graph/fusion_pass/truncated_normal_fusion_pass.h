...
#ifndef OPS_MATH_TRUNCATED_NORMAL_V2_FUSION_PASS_H_
#define OPS_MATH_TRUNCATED_NORMAL_V2_FUSION_PASS_H_
...
class __attribute__((visibility("default"))) TruncatedNormalFusionPass : public PatternFusionPass {
protected:
...
#endif // OPS_MATH_TRUNCATED_NORMAL_V2_FUSION_PASS_H_
