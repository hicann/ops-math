...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnInplaceRandomTensorGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnInplaceRandomTensor”接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>to-1的值需要在selfRef的数据类型取值范围内。</td>
      <td>INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
