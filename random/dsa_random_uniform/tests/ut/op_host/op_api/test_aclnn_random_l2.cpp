...
protected:
    static void SetUpTestCase() { std::cout << "l2_random_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_random_test TearDown" << std::endl; }
};

TEST_F(l2_random_test, aclnnInplaceRandom_3_4_float_nd)
{
    const std::vector<int64_t>& self_shape = {3, 4};
    ...
    const std::vector<int64_t>& out_shape = {3, 4};
...
{
    const std::vector<int64_t>& selfShape = {1, 11};
...
{
    const std::vector<int64_t>& selfShape = {5, 4};
    aclDataType selfDtype = ACL_FLOAT;
    aclFormat selfFormat = ACL_FORMAT_ND;
    const std::vector<int64_t>& selfViewDim = {1, 5};
    int64_t selfOffset = 0;
    const std::vector<int64_t>& selfStorageDim = {4, 5};
...
{
    const std::vector<int64_t>& selfShape = {5, 4, 5, 4, 5, 4, 5, 4, 5};
    aclDataType selfDtype = ACL_FLOAT;
    aclFormat selfFormat = ACL_FORMAT_ND;
