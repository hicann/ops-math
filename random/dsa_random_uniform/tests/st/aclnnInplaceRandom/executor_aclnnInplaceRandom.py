...
@register("ascend_aclnn_inplace_random")
class MethodAclnnInplaceRandomApi(BaseApi):
    def __init__(self, task_result: TaskResult):
        super(MethodAclnnInplaceRandomApi, self).__init__(task_result)
...
@register("aclnn_inplace_random")
class InplaceRandomAclnnApi(AclnnBaseApi):
    def __call__(self):
        super().__call__()
