...
// Test 11: Error case - stdev shape mismatch (not scalar, not equal to output)
TEST_F(StatelessNormalTilingTest, test_stdev_shape_mismatch_error)
{
    optiling::RandomOperatorCompileInfo compileInfo = {40, 196608};
    vector<int64_t> shapeValue = {1024};
    int64_t seedValue = 2;
    ...
    std::vector<float> stdevData(256, 1.0f);  // size 256 != output size 1024
    gert::TilingContextPara tilingContextPara(
        "StatelessNormal",
        {
            {{{1,}, {1,}}, ge::DT_INT64, ge::FORMAT_ND, true, shapeValue.data()},
            ...
            {{{256,}, {256,}}, ge::DT_FLOAT, ge::FORMAT_ND, true, stdevData.data()},
        },
        {
...
// Test 12: Error case - mean shape mismatch with BF16 (not scalar, not equal to output)
TEST_F(StatelessNormalTilingTest, test_mean_shape_mismatch_error)
{
    optiling::RandomOperatorCompileInfo compileInfo = {40, 196608};
    vector<int64_t> shapeValue = {1024};
    int64_t seedValue = 1;
    int64_t offsetValue = 0;
    std::vector<float> meanData(512, 0.0f);  // size 512 != output size 1024
    float stdevValue = 1.0f;
    gert::TilingContextPara tilingContextPara(
        "StatelessNormal",
        {
            {{{1,}, {1,}}, ge::DT_INT64, ge::FORMAT_ND, true, shapeValue.data()},
            {{{1,}, {1,}}, ge::DT_INT64, ge::FORMAT_ND, true, &seedValue},
            {{{1,}, {1,}}, ge::DT_INT64, ge::FORMAT_ND, true, &offsetValue},
            {{{512,}, {512,}}, ge::DT_FLOAT, ge::FORMAT_ND, true, meanData.data()},
