...
#ifndef CANN_CUSTOM_OPS_STATELESS_RANDOM_CHOICE_WITH_MASK_STRUCT_H
#define CANN_CUSTOM_OPS_STATELESS_RANDOM_CHOICE_WITH_MASK_STRUCT_H
...
#endif // CANN_CUSTOM_OPS_STATELESS_RANDOM_CHOICE_WITH_MASK_STRUCT_H