...
- 输入和输出支持以下数据类型组合：
  ...
  - aclnnNpuFormatCastCalculateSizeAndFormat接口参数：
      ...
      | 数据类型：INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32，数据格式：ACL_FORMAT_NC1HWC0(3)   | ACL_FORMAT_NHWC(1) | INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32    | ACL_FORMAT_NHWC(1) |
  ...
  - aclnnNpuFormatCastGetWorkspaceSize接口：
      ...
      | INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32  | INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32          | ACL_FORMAT_FRACTAL_Z_3D(33)       |
      ...
      | INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32  | INT8, UINT8, FLOAT, FLOAT16, BF16, INT32, UINT32          | ACL_FORMAT_NHWC(1)       |
