 ...
 * \brief kernel UT for Assign operator
 */

#include "gtest/gtest.h"
#include "tikicpulib.h"

#include "../../../op_kernel/assign_apt.cpp"

class AssignTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "assign_test SetUp" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "assign_test TearDown" << std::endl;
    }
};

// ============================================================================
// Tensor copy path, tiling key 4 - int32 (4-byte)
// value: (128,) => ref: (128,)
// ============================================================================
TEST_F(AssignTest, test_tensor_four_byte_int32)
{
    constexpr int64_t ELEM_NUM = 128;

    size_t byteSize = ELEM_NUM * sizeof(int32_t);

    uint8_t* ref = (uint8_t*)AscendC::GmAlloc(byteSize);
    uint8_t* value = (uint8_t*)AscendC::GmAlloc(byteSize);
    ...
    ICPU_RUN_KF(assign, numBlocks, ref, value, out, workspace, tiling);
