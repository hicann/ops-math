...
/*!
 * \file test_triu.cpp
 * \brief kernel UT for Triu operator
 */

#include "gtest/gtest.h"
#include "tikicpulib.h"

#include "../../../op_kernel/triu_apt.cpp"

class TriuTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "triu_test SetUp" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "triu_test TearDown" << std::endl;
    }
};

// ============================================================================
// OUTPUT_ZERO mode (tiling key 4) - int32
// All elements above diagonal are zeroed; uses simple SplitAll path
// ============================================================================
TEST_F(TriuTest, test_output_zero_int32)
{
    ...
    ICPU_RUN_KF(triu, numBlocks, x, y, workspace, tiling);
