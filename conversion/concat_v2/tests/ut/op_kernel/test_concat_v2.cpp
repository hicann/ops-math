...
/*!
 * \file test_concat_v2.cpp
 * \brief kernel UT for ConcatV2 operator
 */
...
#include "../../../op_kernel/concat_v2_apt.cpp"

class ConcatV2Test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "concat_v2_test SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "concat_v2_test TearDown" << std::endl; }
};
...
// ============================================================================
TEST_F(ConcatV2Test, test_pure_copy_split_dim1_float32)
{
    ...
    size_t dimByteSize = sizeof(int32_t);
    ...
    ICPU_RUN_KF(concat_v2, numBlocks, x, dimBuf, y, workspace, tiling);

    AscendC::GmFree(x);
    AscendC::GmFree(dimBuf);
    AscendC::GmFree(y);
