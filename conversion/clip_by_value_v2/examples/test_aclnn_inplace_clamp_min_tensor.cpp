...
int PrepareInputAndOutput(std::vector<int64_t>& selfShape, std::vector<int64_t>& minShape, void** selfDeviceAddr,
                          aclTensor** self, void** minDeviceAddr, aclTensor** min)
{
...
void ReleaseDevice(void* selfDeviceAddr, void* minDeviceAddr, uint64_t workspaceSize, void* workspaceAddr,
