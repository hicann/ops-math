...
int PrepareInputAndOutput(std::vector<int64_t>& selfShape, std::vector<int64_t>& outShape,
                          std::vector<int64_t>& maxShape, void** selfDeviceAddr, aclTensor** self, void** maxDeviceAddr,
                          aclTensor** max, void** outDeviceAddr, aclTensor** out)
{
...
void ReleaseDevice(void* selfDeviceAddr, void* maxDeviceAddr, void* outDeviceAddr, uint64_t workspaceSize,
