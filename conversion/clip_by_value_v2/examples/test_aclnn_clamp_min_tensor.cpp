...
int PrepareInputAndOutput(std::vector<int64_t>& selfShape, std::vector<int64_t>& outShape,
                          std::vector<int64_t>& minShape, void** selfDeviceAddr, aclTensor** self, void** minDeviceAddr,
                          aclTensor** min, void** outDeviceAddr, aclTensor** out)
{
...
void ReleaseDevice(void* selfDeviceAddr, void* minDeviceAddr, void* outDeviceAddr, uint64_t workspaceSize,
