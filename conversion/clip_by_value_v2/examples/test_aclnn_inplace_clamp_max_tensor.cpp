...
int PrepareInputAndOutput(std::vector<int64_t>& selfShape, std::vector<int64_t>& maxShape, void** selfDeviceAddr,
                          aclTensor** self, void** maxDeviceAddr, aclTensor** max)
{
...
void ReleaseDevice(void* selfDeviceAddr, void* maxDeviceAddr, uint64_t workspaceSize, void* workspaceAddr,
