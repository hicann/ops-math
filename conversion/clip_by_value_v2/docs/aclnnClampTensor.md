...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="tg-0lax">shape是self、clipValueMin、clipValueMax进行<a href="../../../docs/zh/context/broadcast_relationship.md" target="_blank">broadcast</a>后的shape，数据类型与self的数据类型需满足数据类型转换规则（参见<a href="../../../docs/zh/context/conversion_relationship.md" target="_blank">互转换关系</a>）。</td>
