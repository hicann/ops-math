...
class l2_inplace_clamp_min_tensor_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "l2_inplace_clamp_min_tensor_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "l2_inplace_clamp_min_tensor_test TearDown" << endl; }
};
