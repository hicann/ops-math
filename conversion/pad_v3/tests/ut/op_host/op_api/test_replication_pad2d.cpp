...
TEST_F(replication_pad2d_test, case_1) {
  ...
  auto ut = OP_API_UT(aclnnReplicationPad2d, INPUT(self_tensor_desc, padding_desc),
                                                    OUTPUT(out_desc));
...
TEST_F(replication_pad2d_test, case_3) {
  ...
  auto ut = OP_API_UT(aclnnReplicationPad2d, INPUT(nullptr, padding_desc),
                                                OUTPUT(out_desc));
  ...
  auto ut_2 = OP_API_UT(aclnnReplicationPad2d, INPUT(self_tensor_desc, nullptr),
                                                OUTPUT(out_desc));
  workspace_size = 0;
