 ...
 */
ACLNN_API aclnnStatus aclnnReplicationPad1dGetWorkspaceSize(
...
aclnnReplicationPad1d(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
