 ...
 */
ACLNN_API aclnnStatus aclnnReplicationPad3dGetWorkspaceSize(
...
aclnnReplicationPad3d(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
