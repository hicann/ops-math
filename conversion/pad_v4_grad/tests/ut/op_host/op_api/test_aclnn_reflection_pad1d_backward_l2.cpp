...
class reflection_pad1d_backward_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "reflection_pad1d_backward_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "reflection_pad1d_backward_test TearDown" << endl; }
};
...
TEST_F(reflection_pad1d_backward_test, case_1) {
  ...
  auto ut = OP_API_UT(aclnnReflectionPad1dBackward, INPUT(grad_output_tensor_desc, input_tensor_desc, padding_desc),
...
TEST_F(reflection_pad1d_backward_test, case_2) {
  auto grad_output_tensor_desc = TensorDesc({0, 1, 14}, ACL_FLOAT, ACL_FORMAT_ND);
  auto input_tensor_desc = TensorDesc({0, 1, 10}, ACL_FLOAT, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
  auto grad_input_desc = TensorDesc({0, 1, 10}, ACL_FLOAT, ACL_FORMAT_ND);
  auto ut = OP_API_UT(aclnnReflectionPad1dBackward, INPUT(grad_output_tensor_desc, input_tensor_desc, padding_desc),
                                                  OUTPUT(grad_input_desc));
...
TEST_F(reflection_pad1d_backward_test, case_3) {
  ...
  auto ut = OP_API_UT(aclnnReflectionPad1dBackward, INPUT(nullptr, input_tensor_desc, padding_desc),
                                                OUTPUT(grad_input_desc));
  ...
  auto ut_2 = OP_API_UT(aclnnReflectionPad1dBackward, INPUT(grad_output_tensor_desc, nullptr, padding_desc),
                                                OUTPUT(grad_input_desc));
  workspace_size = 0;
  aclRet = ut_2.TestGetWorkspaceSize(&workspace_size);
  EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

  auto ut_3 = OP_API_UT(aclnnReflectionPad1dBackward, INPUT(grad_output_tensor_desc, input_tensor_desc, nullptr),
                                                OUTPUT(grad_input_desc));
  workspace_size = 0;
...
TEST_F(reflection_pad1d_backward_test, case_19) {
  auto grad_output_tensor_desc = TensorDesc({1, 1, 7}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(1, 1);
...
// padding values are bigger than 16
TEST_F(reflection_pad1d_backward_test, case_20) {
  auto grad_output_tensor_desc = TensorDesc({1, 1, 59}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(1, 1);
  auto input_tensor_desc = TensorDesc({1, 1, 40}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{2, 17});
  auto grad_input_desc = TensorDesc({1, 1, 40}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// padding values are bigger than 11000
TEST_F(reflection_pad1d_backward_test, ascend910B2_case_21) {
  auto grad_output_tensor_desc = TensorDesc({23, 122327}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(1, 1);
  auto input_tensor_desc = TensorDesc({23, 64063}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{37802, 20462});
  auto grad_input_desc = TensorDesc({23, 64063}, ACL_FLOAT16, ACL_FORMAT_ND);
