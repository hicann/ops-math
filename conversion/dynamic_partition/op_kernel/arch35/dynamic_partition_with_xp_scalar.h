...
/*!
 * \file dynamic_partition_with_xp_scalar.h
 * \brief impl of DynamicPartition which x and partitions are all scalar
 */

#ifndef OP_KERNEL_DYNAMIC_PARTITION_WITH_XP_SCALAR_H_
#define OP_KERNEL_DYNAMIC_PARTITION_WITH_XP_SCALAR_H_
...
template <typename T>
class DynPartWithXPScalar : public DynPartBase<T>
{
public:
    __aicore__ inline DynPartWithXPScalar(){};
...
template <typename T>
__aicore__ inline void DynPartWithXPScalar<T>::Init(GM_ADDR x, GM_ADDR partitions, GM_ADDR y, GM_ADDR yshape,
                                                    const DynPartTilingData* tilingDataPtr, TPipe* pipeIn)
{
...
template <typename T>
__aicore__ inline void DynPartWithXPScalar<T>::Process()
{
...
#endif  // OP_KERNEL_DYNAMIC_PARTITION_WITH_XP_SCALAR_H_