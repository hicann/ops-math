...
/*!
 * \file dynamic_partition_with_w_mc.h
 * \brief impl of DynamicPartition which multiple cores at axis W
 */

#ifndef OP_KERNEL_DYNAMIC_PARTITION_WITH_W_MC_H_
#define OP_KERNEL_DYNAMIC_PARTITION_WITH_W_MC_H_
...
class DynPartWithWMC : public DynPartBase<T>
{
public:
    __aicore__ inline DynPartWithWMC(){};
...
__aicore__ inline void DynPartWithWMC<T, isSingleW>::Init(GM_ADDR x, GM_ADDR partitions, GM_ADDR y, GM_ADDR yshape,
                                                          const DynPartTilingData* tilingDataPtr, TPipe* pipeIn)
{
...
template <typename T, bool isSingleW>
__aicore__ inline void DynPartWithWMC<T, isSingleW>::Process()
{
...
#endif  // OP_KERNEL_DYNAMIC_PARTITION_WITH_W_MC_H_