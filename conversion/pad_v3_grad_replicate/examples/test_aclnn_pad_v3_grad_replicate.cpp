...
int main()
{
    ...
    ret =
        aclnnReplicationPad1dBackwardGetWorkspaceSize(gradOutput, self, padding, gradInput, &workspaceSize, &executor);
    CHECK_RET(
        ret == ACL_SUCCESS, LOG_PRINT("aclnnReplicationPad1dBackwardGetWorkspaceSize failed. ERROR: %d\n", ret);
        return ret);
