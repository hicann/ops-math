...
- <term>Kirin X90/Kirin 9030处理器系列产品</term>：数据类型支持FLOAT、FLOAT16。
...
| 调用方式  | 样例代码                                                     | 说明                                                         |
| :-------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| aclnn接口 | [test_aclnn_transpose_v2](./examples/test_aclnn_transpose_v2.cpp) | 通过[aclnnPermute](../transpose/docs/aclnnPermute.md)接口方式调用transposeV2算子。 |
