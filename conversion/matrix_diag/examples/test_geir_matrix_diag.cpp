...
#include "nn_other.h"
#include "../op_graph/matrix_diag_proto.h"
...
#define ADD_INPUT(inputIndex, inputName, inputDtype, inputShape, value)                                  \
    ...
    matrixDiag1.set_input_##inputName(placeholder##inputIndex);                                           \
...
#define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                       \
    ...
    matrixDiag1.update_output_desc_##outputName(outputName##outputIndex##_desc)
