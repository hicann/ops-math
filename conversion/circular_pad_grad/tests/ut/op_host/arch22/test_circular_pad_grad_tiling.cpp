...
#include "../../../../op_host/arch22/circular_pad_grad_tiling.h"
#include "tiling_context_faker.h"
#include "tiling_case_executor.h"

class CircularPadGradTiling : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "CircularPadGradTiling  SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "CircularPadGradTiling  TearDown" << std::endl; }
};
...
TEST_F(CircularPadGradTiling, circular_pad_grad_tiling_test_success)
{
    ...
    gert::TilingContextPara tilingContextPara("CircularPadGrad",
