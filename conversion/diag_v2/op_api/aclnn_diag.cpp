...
#include "conversion/diag_flat/op_api/diag_flat.h"
...
aclnnStatus aclnnDiagGetWorkspaceSize(const aclTensor* self, int64_t diagonal, aclTensor* out, uint64_t* workspaceSize,
