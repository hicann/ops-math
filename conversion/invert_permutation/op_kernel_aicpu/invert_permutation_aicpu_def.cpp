...
namespace ops {
class InvertPermutation : public OpDef {
public:
    explicit InvertPermutation(const char *name) : OpDef(name)
    {
        this->Input("x").DataType({ge::DT_INT32, ge::DT_INT64});
