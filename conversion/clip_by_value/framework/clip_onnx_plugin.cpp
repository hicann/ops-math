...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::Clip"), ge::AscendString("ai.onnx::9::Clip"),
...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::11::Clip"), ge::AscendString("ai.onnx::12::Clip"),
