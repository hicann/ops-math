...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_FORMAT_SEL(ubAxis, TPL_UB_AXIS_N), ),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_FORMAT_SEL(ubAxis, TPL_UB_AXIS_H), ),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_FORMAT_SEL(ubAxis, TPL_UB_AXIS_W), ),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_FORMAT_SEL(ubAxis, TPL_UB_AXIS_C), ), );
