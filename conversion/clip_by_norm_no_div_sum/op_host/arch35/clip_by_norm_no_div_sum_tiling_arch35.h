 ...
 */
/*!
 * \file clip_by_norm_no_div_sum_tiling_arch35.h
 * \brief ClipByNormNoDivSum Tiling — arch35 头文件
 */
#pragma once
#include <cstdint>
#include <vector>
#include <exe_graph/runtime/tiling_context.h>
#include "conversion/clip_by_norm_no_div_sum/op_kernel/arch35/clip_by_norm_no_div_sum_tiling_data.h"
#include "conversion/clip_by_norm_no_div_sum/op_kernel/arch35/clip_by_norm_no_div_sum_struct.h"

// ============================================================
// Tiling 函数模块（无状态，与 CANN 框架零耦合）
// 作用域：namespace clip_by_norm_no_div_sum
// ============================================================
...
// ============================================================
// ClipByNormNoDivSumTiling — CANN 主线：单次归一化 → 映射 rank → 模板填充
// ============================================================
namespace optiling {

struct ClipByNormNoDivSumCompileInfo {
    uint64_t coreNum;
    uint64_t ubSize;
};

class ClipByNormNoDivSumTiling {
public:
    explicit ClipByNormNoDivSumTiling(gert::TilingContext* ctx);
