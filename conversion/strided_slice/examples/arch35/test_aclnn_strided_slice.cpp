...
int main()
{
    ...
    // 调用aclnnStridedSlice第一段接口
    ret = aclnnStridedSliceGetWorkspaceSize(self, begin, end, strides, beginMask, endMask, ellipsisMask, newAxisMask,
                                            shrinkAxisMask, out, &workspaceSize, &executor);
