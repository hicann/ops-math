 ...
 */
ACLNN_API aclnnStatus aclnnSplitTensorGetWorkspaceSize(
...
aclnnSplitTensor(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
