...
template <typename T> class KernelMirrorPadReflect {
public:
        ...
        DataCopyExtParams &copyParams, const uint64_t offset)
    {
        switch (highDims) {
            case 0:
                ...
                break;
            case 1:
                CopyOut2MultiPos1Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            case TWO_DIM:
                CopyOut2MultiPos2Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            case THREE_DIM:
                CopyOut2MultiPos3Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            case FOUR_DIM:
                CopyOut2MultiPos4Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            case FIVE_DIM:
                CopyOut2MultiPos5Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            case SIX_DIM:
                CopyOut2MultiPos6Dim<T, GetDimRefPadIdx>(counts, outBuffer, copyParams, offset, yGm_, frontPads_,
                    backPads_, inputShapes_, afterPadStrides_);
                break;
            default:
                break;
    ...
    __aicore__ inline void FrontPadAndDataAndBackPadCaseRef(const uint32_t counts[], uint64_t &srcStart,
    ...
    __aicore__ inline void FrontPadAndDataCaseRef(const uint32_t counts[], uint64_t &srcStart, uint64_t &dstStart,
    ...
    __aicore__ inline void DataAndBackPadCaseRef(const uint32_t counts[], uint64_t &srcStart, uint64_t &dstStart,
    ...
    __aicore__ inline void SubProcessCutHOpt()
    {
        ...
        for (uint32_t i = 0; i < maxLoopInCore_; ++i) {
            ...
            if (innerIdx < frontPaddingLoop_) {
                ...
                FrontPadAndDataAndBackPadCaseRef(counts, srcStart, dstStart, frontPadSrcStart, backPadSrcStart,
                    innerIdx);
