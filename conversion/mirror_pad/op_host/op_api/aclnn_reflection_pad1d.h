 ...
 */
ACLNN_API aclnnStatus aclnnReflectionPad1dGetWorkspaceSize(
...
aclnnReflectionPad1d(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
