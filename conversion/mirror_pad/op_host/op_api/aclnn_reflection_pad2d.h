 ...
 */
ACLNN_API aclnnStatus aclnnReflectionPad2dGetWorkspaceSize(
...
aclnnReflectionPad2d(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
