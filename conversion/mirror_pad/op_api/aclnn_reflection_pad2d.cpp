...
aclnnStatus aclnnReflectionPad2dGetWorkspaceSize(const aclTensor* self, const aclIntArray* padding, aclTensor* out,
        ...
        *workspaceSize = 0;
        ...
        if (self->GetViewShape().GetDimNum() == 3) {
            OP_LOGE(ACLNN_ERR_PARAM_INVALID,
                    "Expected 3D or 4D tensor with possibly 0 batch size and other non-zero dimensions for input.");
