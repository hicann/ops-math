...
__golden__ = {
    "kernel": {
        "strided_slice_v2": "strided_slice_v2_golden"
    }
}
...
def strided_slice_v2_golden(x, begin, end, axes=None, strides=None,
                            begin_mask: int = 0, end_mask: int = 0,
                            ellipsis_mask: int = 0, new_axis_mask: int = 0,
                            shrink_axis_mask: int = 0, **kwargs):
    '''
    Kernel golden for strided_slice_v2.
    All the parameters follow @strided_slice_v2_def.cpp without outputs.
