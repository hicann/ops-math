...
public:
    const std::vector<ge::DataType> baseDataType = {
        ...
        ge::DT_FLOAT8_E5M2, ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E8M0, ge::DT_INT8,        ge::DT_UINT8,
        ...
        ge::DT_COMPLEX32,   ge::DT_COMPLEX64,     ge::DT_HIFLOAT8,    ge::DT_FLOAT8_E5M2, ge::DT_FLOAT8_E4M3FN,
        ge::DT_FLOAT8_E8M0};
    ...
    explicit StridedSliceV2(const char* name) : OpDef(name)
    {
        ...
        aicore_config.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "strided_slice_v2_apt");
