...
int main() {
  ...
  CHECK_RET(shape != nullptr && begin != nullptr && end != nullptr && strides != nullptr, return -1);
  ...
  ret = aclnnStridedSliceGradGetWorkspaceSize(
      shape, begin, end, strides, dy, beginMask, endMask, ellipsisMask, newAxisMask, shrinkAxisMask, out,
