...
class MaskedSelectV3Tiling : public testing::Test {
protected:
  static void SetUpTestCase() {
    std::cout << "MaskedSelectV3Tiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "MaskedSelectV3Tiling TearDown" << std::endl;
  }
...
TEST_F(MaskedSelectV3Tiling, masked_select_v3_tiling_0) {
  ...
  // compile info
  optiling::MaskedSelectV3CompileInfo compile_info;
  
  std::string op_type("MaskedSelectV3");
  ...
  gert::StorageShape input_x_shape = {{131072, 6}, {131072, 6}};
  gert::StorageShape input_mask_shape = {{131072, 6}, {131072, 6}};
  gert::StorageShape output_y_shape = {{131072, 6}, {131072, 6}};

  auto holder = gert::TilingContextFaker()
                    .NodeIoNum(2, 1)
                    .IrInstanceNum({1, 1})
                    .InputShapes({&input_x_shape, &input_mask_shape})
                    .OutputShapes({&output_y_shape})
  ...
  ASSERT_EQ(tilingKey, 8);
}


TEST_F(MaskedSelectV3Tiling, masked_select_v3_tiling_int32) {
  map<string, string> soc_infos;
  map<string, string> aicore_spec;
  map<string, string> intrinsics;
  GetPlatFormInfos(compile_info_string.c_str(), soc_infos, aicore_spec, intrinsics);
  ...
  gert::StorageShape input_x_shape = {{160, 6}, {160, 6}};
  gert::StorageShape input_mask_shape = {{160, 6}, {160, 6}};
  gert::StorageShape output_y_shape = {{160, 6}, {160, 6}};
  ...
  auto tilingKey = tiling_context->GetTilingKey();
  ASSERT_EQ(tilingKey, 4);
}

TEST_F(MaskedSelectV3Tiling, masked_select_v3_tiling_int16) {
  map<string, string> soc_infos;
  map<string, string> aicore_spec;
  map<string, string> intrinsics;
  GetPlatFormInfos(compile_info_string.c_str(), soc_infos, aicore_spec, intrinsics);
  ...
  auto tilingKey = tiling_context->GetTilingKey();
  ASSERT_EQ(tilingKey, 2);
}

TEST_F(MaskedSelectV3Tiling, masked_select_v3_tiling_bool) {
  map<string, string> soc_infos;
  map<string, string> aicore_spec;
  map<string, string> intrinsics;
  GetPlatFormInfos(compile_info_string.c_str(), soc_infos, aicore_spec, intrinsics);
...
TEST_F(MaskedSelectV3Tiling, masked_select_v3_apt_tiling_bool) {
  map<string, string> soc_infos;
  map<string, string> aicore_spec;
  map<string, string> intrinsics;
