...
int main()
{
    ...
    ret =
        aclnnReplicationPad3dBackwardGetWorkspaceSize(gradOutput, self, padding, gradInput, &workspaceSize, &executor);
    CHECK_RET(
        ret == ACL_SUCCESS, LOG_PRINT("aclnnReplicationPad3dBackwardGetWorkspaceSize failed. ERROR: %d\n", ret);
        return ret);
