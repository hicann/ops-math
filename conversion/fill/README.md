...
<tbody>
  <tr>
    ...
    <td>输入/输出张量</td>
    <td>输入输出张量，支持非连续的Tensor，数据维度不支持8维以上。</td>
    <td>FLOAT、FLOAT16、UINT8、INT8、INT16、INT32、INT64、DOUBLE、COMPLEX64、COMPLEX128、BOOL、BFLOAT16、FLOAT8_E4M3FN、FLOAT8_E5M2、FLOAT8_E8M0、HIFLOAT8</td>
    <td>ND</td>
  </tr>
  <tr>
    <td>value</td>
...
- 数据类型需要满足互推导关系。
- FLOAT8_E4M3FN、FLOAT8_E5M2、FLOAT8_E8M0、HIFLOAT8数据类型仅在<term>Ascend 950PR/Ascend 950DT</term>上支持，其余产品不支持。
- 对于CANN 9.0.0版本，FLOAT8_E4M3FN、FLOAT8_E5M2、FLOAT8_E8M0、HIFLOAT8数据类型不支持。
