...
#ifndef __CIRCULAR_PAD_TILING_H__
#define __CIRCULAR_PAD_TILING_H__
...
inline void InitTilingData(uint8_t* tiling, CircularPadCommonTilingData* const_data)
{
    memcpy(const_data, tiling, sizeof(CircularPadCommonTilingData));
}
