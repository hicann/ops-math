...
#include "../../../op_api/aclnn_circular_pad2d.h"
...
protected:
    static void SetUpTestCase() { std::cout << "circular_pad2d_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "circular_pad2d_test TearDown" << std::endl; }
};
