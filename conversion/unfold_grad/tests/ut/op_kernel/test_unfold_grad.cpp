...
TEST_F(unfold_grad_test, test_case_float32_outputshape_8_2_dim_0_size_3_step_2)
{
    ...
    size_t tilingSize = sizeof(UnfoldGradTilingDataInfo);
    ...
    UnfoldGradTilingDataInfo* tilingData = reinterpret_cast<UnfoldGradTilingDataInfo*>(tiling);
    tilingData->dim = 0;
    tilingData->size = 3;
    tilingData->step = 2;
    tilingData->loop = 0;
...
TEST_F(unfold_grad_test, test_case_bfloat16_outputshape_6_3_dim_1_size_2_step_1)
{
    size_t gradOutSize = 6 * 2 * 2 * sizeof(DT_BF16);
    size_t inputSizeSize = 1 * 3 * sizeof(int64_t);
    size_t outputSize = 6 * 3 * sizeof(DT_BF16);
    size_t tilingSize = sizeof(UnfoldGradTilingDataInfo);
...
TEST_F(unfold_grad_test, test_case_bfloat16_outputshape_8_2_dim_0_size_3_step_2)
{
    size_t gradOutSize = 3 * 2 * 3 * sizeof(DT_BF16);
    size_t inputSizeSize = 1 * 3 * sizeof(int64_t);
    size_t outputSize = 8 * 2 * sizeof(DT_BF16);
    size_t tilingSize = sizeof(UnfoldGradTilingDataInfo);
...
TEST_F(unfold_grad_test, test_case_bfloat16_outputshape_6_3_dim_1_size_1_step_2)
{
    size_t gradOutSize = 6 * 2 * 1 * sizeof(DT_BF16);
    size_t inputSizeSize = 2 * sizeof(int64_t);
    size_t outputSize = 6 * 3 * sizeof(DT_BF16);
    size_t tilingSize = sizeof(UnfoldGradTilingDataInfo);
...
TEST_F(unfold_grad_test, test_case_bfloat16_outputshape_8_2_dim_0_size_2_step_3)
{
    size_t gradOutSize = 3 * 2 * 2 * sizeof(DT_BF16);
    size_t inputSizeSize = 2 * sizeof(int64_t);
    size_t outputSize = 8 * 2 * sizeof(DT_BF16);
    size_t tilingSize = sizeof(UnfoldGradTilingDataInfo);
