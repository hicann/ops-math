...
static graphStatus FillDiagonalV2InferDataTypeFunc(gert::InferDataTypeContext* context)
{
...
IMPL_OP(FillDiagonalV2).InferDataType(FillDiagonalV2InferDataTypeFunc);
