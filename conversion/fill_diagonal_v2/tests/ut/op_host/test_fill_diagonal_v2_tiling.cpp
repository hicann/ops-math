...
protected:
    static void SetUpTestCase() { std::cout << "FillDiagonalV2 Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "FillDiagonalV2 Tiling TearDown" << std::endl; }
};
...
TEST_F(FillDiagonalV2Tiling, test_fill_diagonal_v2_float)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "FillDiagonalV2",
        {{{{16, 16}, {16, 16}}, ge::DT_FLOAT, ge::FORMAT_ND}, {{{16, 16}, {16, 16}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {{{16, 16}, {16, 16}}, ge::DT_FLOAT, ge::FORMAT_ND},
        },
        {gert::TilingContextPara::OpAttr("wrap", Ops::Math::AnyValue::CreateFrom<bool>(false))}, &compileInfo);
...
TEST_F(FillDiagonalV2Tiling, test_fill_diagonal_v2_float16)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "FillDiagonalV2",
        {{{{16, 16}, {16, 16}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{16, 16}, {16, 16}}, ge::DT_FLOAT16, ge::FORMAT_ND}},
        {
