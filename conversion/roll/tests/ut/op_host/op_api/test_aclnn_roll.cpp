...
class l2_roll_test : public testing::Test {
 protected:
  static void SetUpTestCase() {cout << "roll_test SetUp" << endl;}

  static void TearDownTestCase() { std::cout << "roll_test TearDown" << std::endl; }

  void test_run(aclDataType test_dtype, aclFormat test_format, vector<int64_t> view_dims, vector<int64_t> shifts,
  ...
  void test_run_invalid(aclDataType test_dtype, aclFormat test_format, vector<int64_t> view_dims, vector<int64_t> shifts, vector<int64_t> dims){
    const vector<int64_t>& view_dims_final= const_cast <vector<int64_t>&>(view_dims);
  ...
  void test_run_nullptr(aclDataType test_dtype, aclFormat test_format, vector<int64_t> view_dims, vector<int64_t> shifts, vector<int64_t> dims){
    const vector<int64_t>& view_dims_final= const_cast <vector<int64_t>&>(view_dims);
...
TEST_F(l2_roll_test, l2_roll_test_19) {
  test_run_invalid(ACL_FLOAT16,  ACL_FORMAT_ND, {2, 3, 3, 1, 3, 2, 3, 3, 5, 1}, {-1, -1, -40, -30, -1}, {1, 4, 1, 2, 3});
