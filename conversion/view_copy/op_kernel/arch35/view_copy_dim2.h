...
template <typename T>
__aicore__ inline void ViewCopyDim2<T>::Init(GM_ADDR dst, GM_ADDR dstSize, GM_ADDR dstStride, GM_ADDR dstStorageOffset,
                                                       ...
                                                       const DataCopyExtParams& copyParams)
{
    ...
    if (tilingData_->enableMovAlign != 0) {
        ...
        copyParam.dstStride = (loopInfo.loopDstStride[DIM1] - loopInfo.loopSize[DIM0]) * sizeof(T) / GetUbBlockSize();
