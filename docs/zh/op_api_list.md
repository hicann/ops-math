...
| [aclnnBernoulliTensor&aclnnInplaceBernoulliTensor](../../random/stateless_bernoulli/docs/aclnnBernoulliTensor&aclnnInplaceBernoulliTensor.md) | 从伯努利分布中提取二进制随机数（0 或 1），prob为生成二进制随机数的概率，输入的张量用于指定shape。   | |   |
| [aclnnBincount](../../math/bincount/docs/aclnnBincount.md) | 计算非负整数数组中每个数的频率。                             | 默认确定性实现| 默认确定性实现 |
...
| [aclnnDropoutGenMaskV2Tensor](../../random/dsa_gen_bit_mask/docs/aclnnDropoutGenMaskV2Tensor.md)         | 训练过程中，按照概率prob生成mask，用于元素置零。 | 默认确定性实现|   |
...
| [aclnnTopk](../../math/topk/docs/aclnnTopk.md) | 返回输入Tensor在指定维度上的k个极值及索引。                                            | 默认确定性实现|   |
