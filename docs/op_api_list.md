...
| [aclnnAddcdiv&aclnnInplaceAddcdiv](../math/addcdiv/docs/aclnnAddcdiv&aclnnInplaceAddcdiv.md)     | 完成加法计算。 |
| [aclnnAddcmul&aclnnInplaceAddcmul](../math/addcmul/docs/aclnnAddcmul&aclnnInplaceAddcmul.md)     | 执行 tensor1 与 tensor2 的逐元素乘法，将结果乘以标量值value并与输入self/selfRef做逐元素加法。 |
...
| [aclnnBincount](../math/bincount/docs/aclnnBincount.md)|计算非负整数数组中每个数的频率。|
...
| [aclnnInplaceOne](../math/ones_like/docs/aclnnInplaceOne.md)|返回形状和类型相同的张量，所有元素都设置为1。|
