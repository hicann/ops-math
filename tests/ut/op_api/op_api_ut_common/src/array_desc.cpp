...
{
    unique_ptr<aclFloatArray, decltype(&AclFloatArrayReleaseWrapper)> p(
        this->ToAclTypeRawPtr(), AclFloatArrayReleaseWrapper);
    return move(p);
}
...
{
    unique_ptr<aclBoolArray, decltype(&AclBoolArrayReleaseWrapper)> p(
        this->ToAclTypeRawPtr(), AclBoolArrayReleaseWrapper);
    return move(p);
}
