...
int PyScripts::GenerateInput(const string& case_json) const
{
    ...
    PyHolder::GetInstance().Ut_PyTuple_SetItem(
        pArgs.get(), 0, PyHolder::GetInstance().Ut_PyBuildValue("s", case_json.c_str()));
...
int PyScripts::GenerateGolden(const string& case_json, const string& py_script, const string& golden_func) const
{
    ...
    PyHolder::GetInstance().Ut_PyTuple_SetItem(
        pArgs.get(), 0, PyHolder::GetInstance().Ut_PyBuildValue("s", case_json.c_str()));
    PyHolder::GetInstance().Ut_PyTuple_SetItem(
        pArgs.get(), 1, PyHolder::GetInstance().Ut_PyBuildValue("s", py_script.c_str()));
    PyHolder::GetInstance().Ut_PyTuple_SetItem(
        pArgs.get(), 2, PyHolder::GetInstance().Ut_PyBuildValue("s", golden_func.c_str()));
