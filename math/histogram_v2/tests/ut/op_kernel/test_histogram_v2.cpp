...
TEST_F(histogram_v2_test, test_case_0) {
    ...
    system("cp -r ../../../../../../../ops/math/histogram_v2/tests/ut/op_kernel/histogram_v2_data ./");
...
TEST_F(histogram_v2_test, test_case_1) {
    int64_t totalLength = 128;
    int64_t bins = 1;
...
TEST_F(histogram_v2_test, test_case_2) {
    int64_t totalLength = 128;
    int64_t bins = 1;
...
TEST_F(histogram_v2_test, test_case_3) {
    int64_t totalLength = 128;
    int64_t bins = 1;
...
TEST_F(histogram_v2_test, test_case_4) {
    int64_t totalLength = 128;
    int64_t bins = 1;
...
TEST_F(histogram_v2_test, test_case_5) {
    int64_t totalLength = 128;
    int64_t bins = 1;
...
TEST_F(histogram_v2_test, test_case_6) {
    int64_t totalLength = 128;
    int64_t bins = 1;
