...
extern "C" __global__ __aicore__ void histogram_v2(GM_ADDR self, GM_ADDR min, GM_ADDR max, GM_ADDR binsCount,
                                                   GM_ADDR workspace, GM_ADDR tiling);
class histogram_v2_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "histogram_v2_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "histogram_v2_test TearDown\n" << endl; }
};
