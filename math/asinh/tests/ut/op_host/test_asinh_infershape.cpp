...
class AsinhInferShapeTest : public testing::Test {};

TEST_F(AsinhInferShapeTest, DynamicDimension)
{
    gert::InfershapeContextPara contextPara("Asinh",
                                            {
...
TEST_F(AsinhInferShapeTest, UnknownRank)
{
    gert::InfershapeContextPara contextPara("Asinh",
                                            {
