...
int main()
{
    ...
    ret = CreateAclTensor(sortedSequenceHostData, sortedSequenceShape, &sortedSequenceDeviceAddr,
                          aclDataType::ACL_FLOAT, &sortedSequence);
    ...
    CHECK_RET(self != nullptr, LOG_PRINT("aclCreateScalar failed.\n"); return -1);
    bool outInt32 = false;
    bool right = false;
    ...
    ret = aclnnSearchSortedsGetWorkspaceSize(sortedSequence, self, outInt32, right, sorter, out, &workspaceSize,
                                             &executor);
