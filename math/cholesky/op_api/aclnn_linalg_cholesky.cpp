                                                ...
                                                uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    if (last_dim_size != second_last_dim_size) {
        OP_LOGE(ACLNN_ERR_PARAM_INVALID,
                "self must be batches of square matrices, but they are [%ld] by [%ld] matrices", second_last_dim_size,
                last_dim_size);
...
aclnnStatus aclnnLinalgCholesky(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
