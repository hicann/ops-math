...
int main()
{
    ...
    ret = aclnnLinalgCholeskyGetWorkspaceSize(self.get(), false, out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnLinalgCholesky(workspaceAddr.get(), workspaceSize, executor, stream.get());
