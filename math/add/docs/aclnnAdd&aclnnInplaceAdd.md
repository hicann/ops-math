...
- 每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnAddGetWorkspaceSize”或者“aclnnInplaceAddGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnAdd”或者“aclnnInplaceAdd”接口执行计算。
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>shape需要与other满足<a href="../../../docs/zh/context/broadcast_relationship.md">broadcast关系</a>。</li>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>shape需要与self满足<a href="../../../docs/zh/context/broadcast_relationship.md">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT16、INT8、UINT8、BOOL、COMPLEX128、COMPLEX64、BFLOAT16</td>
      <td>ND</td>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>shape需要与other满足<a href="../../../docs/zh/context/broadcast_relationship.md" target="_blank">broadcast关系</a>，且广播后的shape必须等于selfRef的shape。</li>
