...
int main()
{
    ...
    // 调用aclnnTanh第一段接口
    ret = aclnnTanhGetWorkspaceSize(self.get(), out.get(), &workspaceSize, &executor);
    ...
    // 调用aclnnTanh第二段接口
    ret = aclnnTanh(workspaceAddr.get(), workspaceSize, executor, stream.get());
    ...
    ret = aclnnInplaceTanhGetWorkspaceSize(self.get(), &inplaceWorkspaceSize, &inplaceExecutor);
    ...
    ret = aclnnInplaceTanh(inplaceWorkspaceAddr.get(), inplaceWorkspaceSize, inplaceExecutor, stream.get());
