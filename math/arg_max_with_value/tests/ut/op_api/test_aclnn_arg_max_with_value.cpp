...
#include "math/arg_max_with_value/op_api/aclnn_max_dim.h"
...
TEST_F(l2_argmax_with_value_test, aclnnMaxDim_3_4_float_nd_0_nd_keepdim_true)
{
    const int64_t dim = 0;
    const bool keepdim = true;
...
TEST_F(l2_argmax_with_value_test, aclnnMaxDim_3_4_float16_nd_1_nd_keepdim_true)
{
    const int64_t dim = 1;
    const bool keepdim = true;
...
TEST_F(l2_argmax_with_value_test, aclnnMaxDim_2_4_5_int64_nd_0_nd_keepdim_true)
{
    const int64_t dim = 0;
    const bool keepdim = true;
