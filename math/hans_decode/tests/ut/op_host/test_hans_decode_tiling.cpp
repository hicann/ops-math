...
protected:
    static void SetUpTestCase() { std::cout << "HansDecode SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "HansDecode TearDown" << std::endl; }
};
...
TEST_F(HansDecodeTiling, ascend910B1_test_tiling_001)
{
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        compileInfo.coreNum, compileInfo.ubSizePlatForm);
    uint64_t expectTilingKey = 4;
    string expectTilingData = "196608 65536 262144 1048576 65536 65536 48 0 ";
