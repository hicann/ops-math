    ...
    gert::StorageShape& outStorageShape, ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    std::vector<gert::Tensor*> inputTensors = {
        (gert::Tensor*)&input1StorageShape, (gert::Tensor*)&input2StorageShape, (gert::Tensor*)&input3StorageShape,
...
TEST_F(HansDecode, HansDecode_infershape_case_0)
{
    ...
    std::vector<ge::DataType> dtypes = {ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_INT32, ge::DT_FLOAT};
