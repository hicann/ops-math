...
TEST_F(l2_argmin_test, aclnnArgMin_float_nd_discontinues_keepdim) {
  ...
  auto out_tensor_desc = TensorDesc({1,5,7,6}, ACL_INT64, ACL_FORMAT_ND,{210,42,1,7},0,{1,5,6,7}).Precision(0.001, 0.001);
...
TEST_F(l2_argmin_test, aclnnArgMin_8_dims) {
  ...
  auto out_tensor_desc_keepdim = TensorDesc({2,2,2,2,2,2,2,1}, ACL_INT64, ACL_FORMAT_ND).Precision(0.001, 0.001);
