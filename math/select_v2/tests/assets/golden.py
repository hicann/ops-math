...
__golden__ = {
  	"kernel": {
  	    "select_v2": "select_v2_golden"
  	}
}

def select_v2_golden(condition, x1, x2, **kwargs):
    '''
    Kernel golden for select_v2.
    All the parameters follow @select_v2_def.cpp without outputs.
    ...
    dtype = x1.dtype
    con = torch.from_numpy(condition)
