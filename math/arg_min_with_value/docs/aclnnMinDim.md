...
- **参数说明：**
  ...
  <!-- npu="910,310p" id7 -->
  - <term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term>：self和out的数据类型不支持BFLOAT16、INT32。
  <!-- end id7 -->
  <!-- npu="A3,910b" id8 -->
  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：self和out的数据类型不支持INT32。
  <!-- end id8 -->
