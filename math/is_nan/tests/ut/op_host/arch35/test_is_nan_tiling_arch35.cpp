...
protected:
    static void SetUpTestCase() { std::cout << "IsNanTilingTest Ascend C SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "IsNanTilingTest Ascend C TearDown" << std::endl; }
};

TEST_F(IsNanTilingTest, test_tiling_fp16_001)
{
    optiling::IsNanCompileInfo compileInfo = {64, 253952};
    gert::TilingContextPara tilingContextPara("IsNan",
                                              {
