...
/*!
 * \file population_count_infer.cpp
 * \brief PopulationCount operator graph infer datatype resource
 */
...
{
    OP_LOGD(context->GetNodeName(), "Begin to do InferDataType4PopulationCount");
    context->SetOutputDataType(0, ge::DT_UINT8);
    OP_LOGD(context->GetNodeName(), "End to do InferDataType4PopulationCount");
    return GRAPH_SUCCESS;
}

IMPL_OP(PopulationCount).InferDataType(InferDataType4PopulationCount);
