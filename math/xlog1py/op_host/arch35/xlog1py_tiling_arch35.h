...
// Xlog1py Tiling — arch35 头文件
#pragma once
#include <cstdint>
#include <vector>
#include <exe_graph/runtime/tiling_context.h>
#include "../../op_kernel/arch35/xlog1py_tiling_struct.h"
...
class Xlog1pyTiling {
public:
    explicit Xlog1pyTiling(gert::TilingContext* ctx);
