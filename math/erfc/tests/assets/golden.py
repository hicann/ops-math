...
__golden__ = {"kernel": {"erfc": "erfc_golden"}}


def erfc_golden(x, **kwargs):
    """
    Kernel golden for erfc.
    All the parameters follow @erfc_def.cpp without outputs.
