...
- **参数说明：**
  ...
  |------|-------|-----------------------------------------------------------------|----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|-----------|
  | self | 输入    | 公式中的input。                  | 支持[非连续的Tensor](../../../docs/context/非连续的Tensor.md)。      | FLOAT、FLOAT16、BFLOAT16、DOUBLE、INT64、INT32、INT16、INT8、UINT8、BOOL | ND   | 0-8       |
  | out  | 输出    | 公式中的out。                    | 支持[非连续的Tensor](../../../docs/context/非连续的Tensor.md)。 | FLOAT、FLOAT16、BFLOAT16、DOUBLE、INT64、INT32、INT16、INT8、UINT8、BOOL | ND   | 0-8       |
...
- **返回值：**
  ...
  <td align="left">传入的self或out是空指针。</td>
  </tr>
  <tr>
  <td rowspan="3" align="left">ACLNN_ERR_PARAM_INVALID</td>
  <td rowspan="3" align="left">161002</td>
  <td align="left">参数self或out的数据类型不在支持范围内。</td>
  </tr>
  <tr><td align="left">self、out的shape不一致。</td></tr>
  <tr><td align="left">self维度大于8。</td></tr>
  </table>
