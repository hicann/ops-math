...
protected:
    static void SetUpTestCase() { cout << "IsFiniteTiling SetUp" << endl; }

    static void TearDownTestCase() { cout << "IsFiniteTiling TearDown " << endl; }
};
...
TEST_F(IsFiniteTiling, ascend910D1_test_tiling_fp16_001)
{
    ...
    string expectTilingData = "8192 24189255811074 ";
