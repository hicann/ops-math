...
static const std::initializer_list<op::DataType> ASCEND910B_DTYPE_SUPPORT_LIST = {
  ...
  op::DataType::DT_INT32, op::DataType::DT_INT64, op::DataType::DT_INT16, op::DataType::DT_INT8,
...
aclnnStatus aclnnIsPosInfGetWorkspaceSize(const aclTensor *self, aclTensor *out,
