...
public:
    ...
    {
        this->Input("x1").DataType({ge::DT_DOUBLE, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_INT32, ge::DT_INT64,
                                    ge::DT_COMPLEX64, ge::DT_COMPLEX128});
        this->Input("x2").DataType({ge::DT_DOUBLE, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_INT32, ge::DT_INT64,
                                    ge::DT_COMPLEX64, ge::DT_COMPLEX128});
        this->Output("y").DataType({ge::DT_DOUBLE, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_INT32, ge::DT_INT64,
                                    ge::DT_COMPLEX64, ge::DT_COMPLEX128});
