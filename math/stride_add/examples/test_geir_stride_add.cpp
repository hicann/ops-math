...
#include "nn_other.h"
#include "../op_graph/stride_add_proto.h"
...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                         \
    ...
    TensorDesc placeholder##intputIndex##_desc =                                                            \
        TensorDesc(ge::Shape(placeholder##intputIndex##_shape), FORMAT_NCHW, intputDtype);                  \
...
{
    Status ret = SUCCESS;
    auto add1 = op::StrideAdd("stride_add1");
    std::vector<int64_t> x1Shape = {2, 64, 7, 7};   // NCHW: N=2, C=64(=C1_x1*C0=4*16), H=7, W=7
    std::vector<int64_t> x2Shape = {2, 64, 7, 7};   // NCHW: N=2, C=64(=C1_x2*C0=4*16), H=7, W=7
    std::vector<int64_t> yShape = {2, 32, 7, 7};    // NCHW: N=2, C=32(=c1_len*C0=2*16), H=7, W=7
    ...
    add1.set_attr_x1_c1_offset(1);
    add1.set_attr_x2_c1_offset(0);
    add1.set_attr_c1_len(2);
