...
TEST_F(ring_attention_update_test, test_case_0)
{
    ...
    auto read_file_1 =
        ReadFile(path + "/gen_data/prev_softmax_max.bin", softmaxByteSize, prev_softmax_max, softmaxByteSize);
    auto read_file_2 =
        ReadFile(path + "/gen_data/prev_softmax_sum.bin", softmaxByteSize, prev_softmax_sum, softmaxByteSize);
    auto read_file_3 = ReadFile(path + "/gen_data/cur_attn_out.bin", attnByteSize, cur_attn_out, attnByteSize);
    auto read_file_4 =
        ReadFile(path + "/gen_data/cur_softmax_max.bin", softmaxByteSize, cur_softmax_max, softmaxByteSize);
    auto read_file_5 =
        ReadFile(path + "/gen_data/cur_softmax_sum.bin", softmaxByteSize, cur_softmax_sum, softmaxByteSize);
    auto read_file_6 =
        ReadFile(path + "/gen_data/cur_softmax_sum.bin", softmaxByteSize, actual_seq_qlen, softmaxByteSize);
    ...
    ICPU_RUN_KF(
        ring_attention_update, blockDim, prev_attn_out, prev_softmax_max, prev_softmax_sum, cur_attn_out,
        cur_softmax_max, cur_softmax_sum, actual_seq_qlen, attn_out, softmax_max, softmax_sum, workspace, tiling);
