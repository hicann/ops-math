...
static void ExeTestCase(
    ...
    const ge::DataType& attnOutDtype, const ge::DataType& softmaxDtype, gert::StorageShape& attnOutShape,
    gert::StorageShape& softmaxMaxShape, gert::StorageShape& softmaxSumShape,
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    /* make infershape context */
    std::vector<gert::Tensor*> inputTensors = {(gert::Tensor*)&prevAttnOutShape,    (gert::Tensor*)&prevSoftmaxMaxShape,
                                               (gert::Tensor*)&prevSoftmaxSumShape, (gert::Tensor*)&curAttnOutShape,
                                               (gert::Tensor*)&curSoftmaxMaxShape,  (gert::Tensor*)&curSoftmaxSumShape};
