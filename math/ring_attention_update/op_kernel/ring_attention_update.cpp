    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(0)) {
        ...
        op.Init(
            prevAttnOut, prevSoftmaxMax, prevSoftmaxSum, curAttnOut, curSoftmaxMax, curSoftmaxSum, actualSeqQlen,
            attnOut, softmaxMax, softmaxSum, userWorkspace, tilingData, &pipe);
        op.Process();
