...
#define ADD_INPUT(inputIndex, inputName, inputDtype, inputShape)                                                     \
    ...
    tan1.set_input_##inputName(placeholder##inputIndex);                                                             \
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < input_num; i++) {
        ...
        string input_file = "./tc_ge_irrun_test_tan_npu_input_" + std::to_string(i) + ".bin";
    ...
    for (int i = 0; i < output_num; i++) {
        ...
        string output_file = "./tc_ge_irrun_test_tan_npu_output_" + std::to_string(i) + ".bin";
