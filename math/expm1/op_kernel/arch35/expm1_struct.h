...
#ifndef OPS_MATH_EXPM1_STRUCT_H_
#define OPS_MATH_EXPM1_STRUCT_H_
...
ASCENDC_TPL_ARGS_DECL(
    Expm1, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif // OPS_MATH_EXPM1_STRUCT_H_