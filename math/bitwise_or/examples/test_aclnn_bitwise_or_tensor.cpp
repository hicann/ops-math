...
int main()
{
    ...
    ret = aclnnBitwiseOrTensorGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnBitwiseOrTensor(workspaceAddr.get(), workspaceSize, executor, stream.get());
