...
int main()
{
    ...
    // 调用aclnnSilentCheck第一段接口
    ret = aclnnSilentCheckGetWorkspaceSize(val, inputGrad, sfda, step, c_min_steps, c_thresh_l1, c_coeff_l1,
                                           c_thresh_l2, c_coeff_l2, npu_asd_detect, result, &workspaceSize, &executor);
