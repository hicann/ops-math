...
ge::graphStatus ComplexTiling::DoOpTiling()
{
    ...
    if (outputDtype == ge::DT_COMPLEX64) {
        ...
        OP_LOGE_FOR_INVALID_DTYPE(
            context_->GetNodeName(), "output", ge::TypeUtils::DataTypeToSerialString(outputDtype),
            "COMPLEX64, COMPLEX32");
...
ge::graphStatus TilingPrepareForComplex(gert::TilingParseContext* context)
{
    ...
    OP_CHECK_IF((compileInfoPtr->coreNum == 0), OP_LOGE(context, "The core num is invalid."), return ge::GRAPH_FAILED);
    ascendcPlatform.GetCoreMemSize(platform_ascendc::CoreMemType::UB, compileInfoPtr->ubSize);
    OP_CHECK_IF((compileInfoPtr->ubSize == 0), OP_LOGE(context, "The ubSize is invalid."), return ge::GRAPH_FAILED);
