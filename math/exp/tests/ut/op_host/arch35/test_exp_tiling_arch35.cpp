...
protected:
    static void SetUpTestCase() { std::cout << "ExpTilingTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ExpTilingTest TearDown" << std::endl; }
};

TEST_F(ExpTilingTest, test_tiling_fp32_attr_work_006)
{
    optiling::ElewiseCompileInfo compileInfo = {64, 262144};
    gert::TilingContextPara tilingContextPara("Exp",
                                              {
