 ...
 */
ACLNN_API aclnnStatus aclnnTriangularSolveGetWorkspaceSize(
...
aclnnTriangularSolve(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
