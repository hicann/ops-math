...
#include "math/mul_addn/op_host/mul_addn_tiling.h"
...
TEST_F(MulAddnTiling, test_tiling_float16_case)
{
    ...
    MulAddnCompileInfo compile_info;

    std::string op_type("MulAddn");
...
TEST_F(MulAddnTiling, test_tiling_float32_case)
{
    gert::StorageShape x1Shape = {{1500, 512, 1}, {1500, 512, 1}};
    gert::StorageShape x2Shape = {{1500, 1, 128}, {1500, 1, 128}};
    // output
...
TEST_F(MulAddnTiling, test_tiling_bfloat16_case)
{
    gert::StorageShape x1Shape = {{1500, 512, 1}, {1500, 512, 1}};
    gert::StorageShape x2Shape = {{1500, 1, 128}, {1500, 1, 128}};
    // output
