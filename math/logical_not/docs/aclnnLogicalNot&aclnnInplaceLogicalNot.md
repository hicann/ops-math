...
- 每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnLogicalNotGetWorkspaceSize”或者”aclnnInplaceLogicalNotGetWorkspaceSize“接口获取入参并根据流程计算所需workspace大小，再调用“aclnnLogicalNot”或者”aclnnInplaceLogicalNot“接口执行计算。
