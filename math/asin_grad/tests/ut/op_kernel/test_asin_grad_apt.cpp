...
protected:
    static void SetUpTestCase() { cout << "AsinGradKernelTest SetUp" << endl; }
    static void TearDownTestCase() { cout << "AsinGradKernelTest TearDown" << endl; }
};

TEST_F(AsinGradKernelTest, test_fp32_basic)
{
...
TEST_F(AsinGradKernelTest, test_fp32_large)
{
