...
static const aclTensor *FloorDivAiCore(const aclTensor *self, const aclTensor *other, aclTensor *floorDivOut,
    ...
    OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "FloorDivAiCore ADD_TO_LAUNCHER_LIST_AICORE failed."), return nullptr);
    return floorDivOut;
}
...
static const aclTensor *FloorDivAiCpu(const aclTensor *self, const aclTensor *other, aclTensor *floorDivOut,
    ...
    OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "FloorDivAiCpu ADD_TO_LAUNCHER_LIST_AICPU failed."), return nullptr);
    return floorDivOut;
}
