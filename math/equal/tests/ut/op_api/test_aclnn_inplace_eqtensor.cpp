...
#include "math/equal/op_api/aclnn_eq_tensor.h"
...
class l2_inplace_eq_tensor_test : public testing::Test {
 protected:
  ...
  static void TearDownTestCase() { std::cout << "inplace_eq_tensor_test TearDown" << std::endl; }
};
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal02) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_FLOAT, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<float>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal03) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_INT16, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<int16_t>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal04) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_DOUBLE, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<double>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal05) {
  auto tensor_self = TensorDesc({2, 3, 2}, ACL_BOOL, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<bool>{false,true,true,true,true,true,false,true,true,true,true,true});

  auto tensor_other = TensorDesc({2, 1, 2}, ACL_BOOL, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<bool>{true,true,true,false});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal06) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_INT64, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<int64_t>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal07) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_UINT8, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<uint8_t>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal08) {
  ...
  auto tensor_other = TensorDesc({2, 1, 2}, ACL_FLOAT16, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<float>{1,2,2,1});
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_normal09) {
  auto tensor_self = TensorDesc({2, 2, 3, 2}, ACL_FLOAT, ACL_FORMAT_NCHW)
                         .ValueRange(-10, 10)
                         .Value(vector<float>{1,2,4,3,2,1,1,2,4,3,2,1,1,2,4,3,2,1,1,2,4,3,2,1});

  auto tensor_other = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_input_self_is_empty) {
  ...
  auto tensor_other = TensorDesc({2, 3},
            ACL_FLOAT,
            ACL_FORMAT_ND,
            {},
            0,
...
TEST_F(l2_inplace_eq_tensor_test, test_inplace_eq_tensor_input_other_is_empty) {
  auto tensor_self = TensorDesc({2, 3},
            ACL_FLOAT,
            ACL_FORMAT_ND,
            {},
            0,
  ...
  auto tensor_other = TensorDesc({2, 0},
            ACL_FLOAT,
            ACL_FORMAT_ND,
            {},
            0,
