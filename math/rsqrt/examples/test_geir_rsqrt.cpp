...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                          \
    do {                                                                                                     \
        ...
        auto placeholder##intputIndex = op::Data(std::string("placeholder") + std::to_string(intputIndex))   \
                                            .set_attr_index(0);                                              \
        ...
        ret = GenOnesDataDouble(placeholder##intputIndex##_shape, tensor_placeholder##intputIndex,           \
                                placeholder##intputIndex##_desc, 2.0);                                       \
        if (ret != SUCCESS) {                                                                                \
