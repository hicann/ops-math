...
class l2_log_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "log_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "log_test TearDown" << endl; }
};
...
/* 走aicpu，暂时不支持，先注释掉
TEST_F(l2_log_test, case_004_INT32) {
...
// 走aicpu，暂时不支持，先注释掉
TEST_F(l2_log_test, case_005_INT16) {
...
TEST_F(l2_log_test, case_006_INT8) {
...
TEST_F(l2_log_test, case_007_UINT8) {
...
// 走aicpu，暂时不支持，先注释掉
TEST_F(l2_log_test, case_008_BOOL) {
...
// 走aicpu，暂时不支持，先注释掉
TEST_F(l2_log_test, case_009_BF16) {
