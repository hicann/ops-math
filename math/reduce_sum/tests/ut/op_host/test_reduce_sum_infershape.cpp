...
protected:
    static void SetUpTestCase() { std::cout << "ReduceSumTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ReduceSumTest TearDown" << std::endl; }
};
...
// ==================== 标量输入, keep_dims=true ====================
TEST_F(ReduceSumTest, ReduceSum_scalar_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
// 输出shape与输入相同
TEST_F(ReduceSumTest, ReduceSum_empty_axes_noop_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
        {
...
// 所有轴归约为1
TEST_F(ReduceSumTest, ReduceSum_empty_axes_noop_false_keepdims_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
        {
...
// 输出为标量
TEST_F(ReduceSumTest, ReduceSum_empty_axes_noop_false_keepdims_false)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
        {
...
// 标量输入保持不变
TEST_F(ReduceSumTest, ReduceSum_empty_axes_noop_true_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
        {
...
// ==================== 标量继续保持标量
TEST_F(ReduceSumTest, ReduceSum_empty_axes_noop_false_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
        {
...
TEST_F(ReduceSumTest, ReduceSum_zero_dim_axes_noop_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_zero_dim_axes_noop_false_keepdims_false)
{
    std::vector<int32_t> axesValue = {};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_int64_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_int64_keepdims_false)
{
    std::vector<int64_t> axesValue = {1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_int64_neg_axes_keepdims_true)
{
    std::vector<int64_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_int64_neg_axes_keepdims_false)
{
...
TEST_F(ReduceSumTest, ReduceSum_invalid_axes_dtype)
{
...
TEST_F(ReduceSumTest, ReduceSum_invalid_axes_bounds)
{
...
TEST_F(ReduceSumTest, ReduceSum_invalid_axes_bounds_neg)
{
...
TEST_F(ReduceSumTest, ReduceSum_invalid_axes_bounds_scalar)
{
...
TEST_F(ReduceSumTest, ReduceSum_all_dims_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_all_dims_keepdims_false)
{
    std::vector<int32_t> axesValue = {0, 1, 2, 3};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_1d_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_1d_keepdims_false)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
// ==================== 单轴归约, keep_dims=true ====================
TEST_F(ReduceSumTest, ReduceSum_single_axis_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_single_axis_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_dynamic_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_dynamic_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_neg_axes_keepdims_true)
{
    std::vector<int32_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_int64_5d_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_int64_5d_keepdims_false)
{
    std::vector<int64_t> axesValue = {2, 4};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_int64_scalar_keepdims_true)
{
...
TEST_F(ReduceSumTest, ReduceSum_multi_dim_axes_flatten)
{
    std::vector<int32_t> axesValue = {1, 2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
// ==================== 未知秩输入 ({-2}) → 输出 {-2} ====================
TEST_F(ReduceSumTest, ReduceSum_unknown_rank)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceSum",
...
TEST_F(ReduceSumTest, ReduceSum_infer_datatype)
{
    auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
    ASSERT_NE(spaceRegistry, nullptr);
    auto opImpl = spaceRegistry->GetOpImpl("ReduceSum");
    ASSERT_NE(opImpl, nullptr);
    ASSERT_NE(opImpl->infer_datatype, nullptr);

    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("ReduceSum").OpName("ReduceSum");
    builder.IONum(2, 1);
...
TEST_F(ReduceSumTest, ReduceSum_infer_shape_range)
{
    auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
    ASSERT_NE(spaceRegistry, nullptr);
    auto opImpl = spaceRegistry->GetOpImpl("ReduceSum");
