 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnXLogYScalarSelfGetWorkspaceSize(
...
aclnnXLogYScalarSelf(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
#ifdef __cplusplus
}
#endif
