...
class AsinhGradInfershapeTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "AsinhGradInfershapeTest SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "AsinhGradInfershapeTest TearDown" << std::endl;
  }
};

TEST_F(AsinhGradInfershapeTest, asinh_grad_infershape_2d) {
...
TEST_F(AsinhGradInfershapeTest, asinh_grad_infershape_1d) {
...
TEST_F(AsinhGradInfershapeTest, asinh_grad_infershape_3d) {
...
TEST_F(AsinhGradInfershapeTest, asinh_grad_infershape_4d) {
