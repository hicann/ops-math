 ...
 public:
  explicit LinSpace(const char* name) : OpDef(name) {
    this->Input("start")
        ...
        .DataType({ge::DT_INT8, ge::DT_UINT8, ge::DT_INT32, ge::DT_FLOAT, ge::DT_FLOAT16,
                   ge::DT_INT8, ge::DT_UINT8, ge::DT_INT32, ge::DT_FLOAT, ge::DT_FLOAT16})
    ...
    config.Input("start")
        .ParamType(REQUIRED)
        .ValueDepend(OPTIONAL)
        .DataType({ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16, ge::DT_INT32, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16,
