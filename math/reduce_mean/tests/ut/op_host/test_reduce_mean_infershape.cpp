...
protected:
    static void SetUpTestCase() { std::cout << "ReduceMeanTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ReduceMeanTest TearDown" << std::endl; }
};

// ==================== 非空axes, DT_INT32, keep_dims=true ====================
TEST_F(ReduceMeanTest, ReduceMean_const_infer_1)
{
...
TEST_F(ReduceMeanTest, ReduceMean_const_infer_2)
{
    std::vector<int32_t> axesValue = {1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_const_infer_scalar)
{
...
// ==================== 标量输入, keep_dims=true ====================
TEST_F(ReduceMeanTest, ReduceMean_scalar_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
// 输出shape与输入相同
TEST_F(ReduceMeanTest, ReduceMean_empty_axes_noop_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
        {
...
// 所有轴归约为1
TEST_F(ReduceMeanTest, ReduceMean_empty_axes_noop_false_keepdims_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
        {
...
// 输出为标量
TEST_F(ReduceMeanTest, ReduceMean_empty_axes_noop_false_keepdims_false)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
        {
...
// 标量输入保持不变
TEST_F(ReduceMeanTest, ReduceMean_empty_axes_noop_true_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
        {
...
// ==================== 标量继续保持标量
TEST_F(ReduceMeanTest, ReduceMean_empty_axes_noop_false_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
        {
...
TEST_F(ReduceMeanTest, ReduceMean_zero_dim_axes_noop_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_zero_dim_axes_noop_false_keepdims_false)
{
    std::vector<int32_t> axesValue = {};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_int64_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_int64_keepdims_false)
{
    std::vector<int64_t> axesValue = {1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_int64_neg_axes_keepdims_true)
{
    std::vector<int64_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_int64_neg_axes_keepdims_false)
{
...
TEST_F(ReduceMeanTest, ReduceMean_invalid_axes_dtype)
{
...
TEST_F(ReduceMeanTest, ReduceMean_invalid_axes_bounds)
{
...
TEST_F(ReduceMeanTest, ReduceMean_invalid_axes_bounds_neg)
{
...
TEST_F(ReduceMeanTest, ReduceMean_invalid_axes_bounds_scalar)
{
...
TEST_F(ReduceMeanTest, ReduceMean_all_dims_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_all_dims_keepdims_false)
{
    std::vector<int32_t> axesValue = {0, 1, 2, 3};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_1d_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_1d_keepdims_false)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
// ==================== 单轴归约, keep_dims=true ====================
TEST_F(ReduceMeanTest, ReduceMean_single_axis_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_single_axis_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_dynamic_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_dynamic_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_neg_axes_keepdims_true)
{
    std::vector<int32_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_int64_5d_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_int64_5d_keepdims_false)
{
    std::vector<int64_t> axesValue = {2, 4};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
TEST_F(ReduceMeanTest, ReduceMean_int64_scalar_keepdims_true)
{
...
TEST_F(ReduceMeanTest, ReduceMean_multi_dim_axes_flatten)
{
    std::vector<int32_t> axesValue = {1, 2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
...
// ==================== 未知秩输入 ({-2}) → 输出 {-2} ====================
TEST_F(ReduceMeanTest, ReduceMean_unknown_rank)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMean",
