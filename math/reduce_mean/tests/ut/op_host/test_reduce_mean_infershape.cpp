...
class ReduceMeanTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ReduceMeanTest SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ReduceMeanTest TearDown" << std::endl;
  }
};

TEST_F(ReduceMeanTest, reduce_mean_infer_shape_rt01) {
...
TEST_F(ReduceMeanTest, reduce_mean_infer_shape_rt02) {
  std::vector<int32_t> axesValue = {1, 2};
 	gert::InfershapeContextPara infershapeContextPara(
    "ReduceMean",
 	  {
