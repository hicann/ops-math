...
TEST_F(ReduceMeanKernelTest, INT32_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_int32_input1.txt",
                                      "data/reduce_mean_int32_input2.txt",
                                      "data/reduce_mean_int32_output.txt"};
...
TEST_F(ReduceMeanKernelTest, INT32_ALL_DIM1_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_int32_2_input1.txt",
                                      "data/reduce_mean_int32_2_input2.txt",
                                      "data/reduce_mean_int32_2_output.txt"};
  RunReduceMeanKernel<int32_t, int32_t>(data_files, DT_INT32, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, INT32_DIM1_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{3, 3, 1, 4}, {1}, {3, 4}};
  std::vector<std::string> data_files{"data/reduce_mean_int32_3_input1.txt",
                                      "data/reduce_mean_int32_3_input2.txt",
                                      "data/reduce_mean_int32_3_output.txt"};
  RunReduceMeanKernel<int32_t, int32_t>(data_files, DT_INT32, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, INT64_INT64_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{2, 3, 6}, {1}, {2, 6}};
  std::vector<std::string> data_files{"data/reduce_mean_int64_input1.txt",
                                      "data/reduce_mean_int64_input2.txt",
                                      "data/reduce_mean_int64_output.txt"};
...
TEST_F(ReduceMeanKernelTest, FLOAT_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_float_input1.txt",
                                      "data/reduce_mean_float_input2.txt",
                                      "data/reduce_mean_float_output.txt"};
...
TEST_F(ReduceMeanKernelTest, FLOAT2_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_float2_input1.txt",
                                      "data/reduce_mean_float2_input2.txt",
                                      "data/reduce_mean_float2_output.txt"};
  RunReduceMeanKernel<float, int32_t>(data_files, DT_FLOAT, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, FLOAT3_INT32_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{4, 3, 5, 6}, {1}, {4, 3, 6}};
  std::vector<std::string> data_files{"data/reduce_mean_float3_input1.txt",
                                      "data/reduce_mean_float3_input2.txt",
                                      "data/reduce_mean_float3_output.txt"};
  RunReduceMeanKernel<float, int32_t>(data_files, DT_FLOAT, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, FLOAT16_INT32_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{2, 3, 2, 3}, {2}, {3, 3}};
  std::vector<std::string> data_files{"data/reduce_mean_float16_input1.txt",
                                      "data/reduce_mean_float16_input2.txt",
                                      "data/reduce_mean_float16_output.txt"};
...
TEST_F(ReduceMeanKernelTest, DOUBLE_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_double_input1.txt",
                                      "data/reduce_mean_double_input2.txt",
                                      "data/reduce_mean_double_output.txt"};
...
TEST_F(ReduceMeanKernelTest, DOUBLE2_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_double2_input1.txt",
                                      "data/reduce_mean_double2_input2.txt",
                                      "data/reduce_mean_double2_output.txt"};
  RunReduceMeanKernel<double, int32_t>(data_files, DT_DOUBLE, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, INT8_INT32_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{2, 3, 2, 3, 2, 3, 2}, {4}, {3, 3, 3}};
  std::vector<std::string> data_files{"data/reduce_mean_int8_input1.txt",
                                      "data/reduce_mean_int8_input2.txt",
                                      "data/reduce_mean_int8_output.txt"};
...
TEST_F(ReduceMeanKernelTest, UINT8_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_uint8_input1.txt",
                                      "data/reduce_mean_uint8_input2.txt",
                                      "data/reduce_mean_uint8_output.txt"};
...
TEST_F(ReduceMeanKernelTest, INT16_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_int16_input1.txt",
                                      "data/reduce_mean_int16_input2.txt",
                                      "data/reduce_mean_int16_output.txt"};
...
TEST_F(ReduceMeanKernelTest, UINT16_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_uint16_input1.txt",
                                      "data/reduce_mean_uint16_input2.txt",
                                      "data/reduce_mean_uint16_output.txt"};
...
TEST_F(ReduceMeanKernelTest, UINT32_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_uint32_input1.txt",
                                      "data/reduce_mean_uint32_input2.txt",
                                      "data/reduce_mean_uint32_output.txt"};
...
TEST_F(ReduceMeanKernelTest, UINT64_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_uint64_input1.txt",
                                      "data/reduce_mean_uint64_input2.txt",
                                      "data/reduce_mean_uint64_output.txt"};
...
TEST_F(ReduceMeanKernelTest, COMPLEX64_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_complex64_input1.txt",
                                      "data/reduce_mean_complex64_input2.txt",
                                      "data/reduce_mean_complex64_output.txt"};
...
TEST_F(ReduceMeanKernelTest, COMPLEX128_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_complex128_input1.txt",
                                      "data/reduce_mean_complex128_input2.txt",
                                      "data/reduce_mean_complex128_output.txt"};
...
TEST_F(ReduceMeanKernelTest, COMPLEX64_2_INT32_SUCC) {
  ...
  std::vector<std::string> data_files{"data/reduce_mean_complex64_2_input1.txt",
                                      "data/reduce_mean_complex64_2_input2.txt",
                                      "data/reduce_mean_complex64_2_output.txt"};
  RunReduceMeanKernel<std::complex<float>, int32_t>(data_files, DT_COMPLEX64, DT_INT32, shapes);
}

TEST_F(ReduceMeanKernelTest, COMPLEX128_2_INT32_SUCC) {
  std::vector<std::vector<int64_t>> shapes = {{4, 5, 2, 1}, {2}, {4, 2}};
  std::vector<std::string> data_files{"data/reduce_mean_complex128_2_input1.txt",
                                      "data/reduce_mean_complex128_2_input2.txt",
                                      "data/reduce_mean_complex128_2_output.txt"};
  RunReduceMeanKernel<std::complex<double>, int32_t>(data_files, DT_COMPLEX128, DT_INT32, shapes);
}
