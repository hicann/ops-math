...
static std::map<DataType, std::function<uint32_t(CpuKernelContext*, const QuickVector&)>> kreduce_mean_calls = {
    {DT_FLOAT16, ReductionOp<Eigen::half, Eigen::internal::MeanReducer<Eigen::half>>},
    {DT_FLOAT, ReductionOp<float, Eigen::internal::MeanReducer<float>>},
    {DT_DOUBLE, ReductionOp<double, Eigen::internal::MeanReducer<double>>},
    {DT_INT8, ReductionOp<int8_t, Eigen::internal::MeanReducer<int8_t>>},
    {DT_INT16, ReductionOp<int16_t, Eigen::internal::MeanReducer<int16_t>>},
    {DT_INT32, ReductionOp<int32_t, Eigen::internal::MeanReducer<int32_t>>},
    {DT_INT64, ReductionOp<int64_t, Eigen::internal::MeanReducer<int64_t>>},
    {DT_UINT8, ReductionOp<uint8_t, Eigen::internal::MeanReducer<uint8_t>>},
    {DT_UINT16, ReductionOp<uint16_t, Eigen::internal::MeanReducer<uint16_t>>},
    {DT_UINT32, ReductionOp<uint32_t, Eigen::internal::MeanReducer<uint32_t>>},
    {DT_UINT64, ReductionOp<uint64_t, Eigen::internal::MeanReducer<uint64_t>>},
    {DT_COMPLEX64, ReductionOp<std::complex<float>, ComplexFloatMeanReducer>},
    {DT_COMPLEX128, ReductionOp<std::complex<double>, ComplexDoubleMeanReducer>}};
} // namespace
...
OPS_MATH_REGISTER_CPU_KERNELV2(kReduceMean, ReduceMeanCpuKernel);
} // namespace aicpu
