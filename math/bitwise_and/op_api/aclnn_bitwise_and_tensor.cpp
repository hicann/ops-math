 ...
 *               \            /
 *   promoteType == BOOL ? LogicalAnd(workspace_4) : BitwiseAnd(workspace_4)
 *                    |
 *              Cast(workspace_5)
 *                    |
 *                ViewCopy
...
aclnnStatus aclnnBitwiseAndTensorGetWorkspaceSize(const aclTensor* self, const aclTensor* other, aclTensor* out,
...
aclnnStatus aclnnInplaceBitwiseAndTensor(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
                                         aclrtStream stream)
{
