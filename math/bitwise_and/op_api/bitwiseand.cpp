...
static const std::initializer_list<op::DataType> ASCEND950_AICORE_DTYPE_SUPPORT_LIST = {
    op::DataType::DT_INT8,  op::DataType::DT_INT16,  op::DataType::DT_UINT8, op::DataType::DT_UINT16,
                                         ...
                                         aclOpExecutor* executor)
{
    ...
    OP_CHECK(ret == ACL_SUCCESS,
             OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "BitwiseAndAiCore ADD_TO_LAUNCHER_LIST_AICORE failed."), return nullptr);
                                        ...
                                        aclOpExecutor* executor)
{
    ...
    OP_CHECK(ret == ACL_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "BitwiseAndAiCpu ADD_TO_LAUNCHER_LIST_AICPU failed."),
             return nullptr);
    return BitwiseAndOut;
}
