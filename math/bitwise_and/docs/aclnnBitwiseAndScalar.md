...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>公式中的self。</td>
      <td>数据类型与other需满足数据类型推导规则（参见<a href="../../../docs/zh/context/互转换关系.md" target="_blank">互转换关系</a>），推导后的数据类型需在支持的数据类型范围内。</td>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的other。</td>
      <td>数据类型与self需满足数据类型推导规则（参见<a href="../../../docs/zh/context/互转换关系.md" target="_blank">互转换关系</a>），推导后的数据类型需在支持的数据类型范围内。</td>
      <td>INT16、UINT16、INT32、INT64、INT8、UINT8、BOOL</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>公式中的out。</td>
      <td>数据类型需要是self与other推导之后可转换的数据类型（参见<a href="../../../docs/zh/context/互转换关系.md" target="_blank">互转换关系</a>），shape需要与self保持一致。</td>
