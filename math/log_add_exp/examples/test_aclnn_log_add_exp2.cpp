...
int main()
{
    ...
    ret = aclnnLogAddExp2GetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnLogAddExp2(workspaceAddr.get(), workspaceSize, executor, stream.get());
