...
/*!
 * \file complex_abs_infershape.cpp
 * \brief
 */
...
namespace ops {
static graphStatus InferDataType4ComplexAbs(gert::InferDataTypeContext* context)
{
    OP_LOGD(context->GetNodeName(), "InferDataType4ComplexAbs enter");
...
IMPL_OP_INFERSHAPE(ComplexAbs).InferShape(InferShape4Elewise).InferDataType(InferDataType4ComplexAbs);
} // namespace ops
