...
TEST_F(TransformBiasRescaleQkvTilingData, TransformBiasRescaleQkvTilingData_01)
{
    ...
    platform_info.Init();
    // compile info
    optiling::TransformBiasRescaleQkvCompileInfo compile_info;

    std::string op_type("TransformBiasRescaleQkv");
    ...
    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(2, 3)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&qkv_shape, &qkv_bias_shape})
                      .OutputShapes({&q_shape, &k_shape, &v_shape})
                      ...
                      .NodeAttrs({{"num_heads", ge::AnyValue::CreateFrom<int64_t>(3)}})
