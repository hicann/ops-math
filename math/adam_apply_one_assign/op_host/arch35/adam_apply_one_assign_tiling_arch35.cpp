...
#include "math/adam_apply_one_assign/op_kernel/arch35/adam_struct.h"
#include <algorithm>
...
{
    auto compileInfo = reinterpret_cast<const AdamCompileInfo*>(ctx_->GetCompileInfo());
...
ge::graphStatus AdamTiling::DoTilingAndSet()
{
    ...
    auto* compileInfo = reinterpret_cast<const AdamCompileInfo*>(
        ctx_->GetCompileInfo());
