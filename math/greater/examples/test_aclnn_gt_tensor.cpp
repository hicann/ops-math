...
int main()
{
    ...
    ret = aclnnGtTensorGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnGtTensor(workspaceAddr.get(), workspaceSize, executor, stream.get());
