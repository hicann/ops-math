...
/* !
 * \file rint_tiling_struct.h
 * \brief
 */

#ifndef RINT_TILING_STRUCT_H
#define RINT_TILING_STRUCT_H
...
ASCENDC_TPL_ARGS_DECL(Rint, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
