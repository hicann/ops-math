...
class ErfInferShape : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "Erf InferShape SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "Erf InferShape TearDown" << std::endl;
    }
};

TEST_F(ErfInferShape, erf_infershape_diff_test)
{
...
TEST_F(ErfInferShape, erf_infershape_same_test)
{
    gert::InfershapeContextPara infershapeContextPara(
        "Erf",
        {
...
TEST_F(ErfInferShape, erf_infershape_dynamic_test)
{
    gert::InfershapeContextPara infershapeContextPara(
        "Erf",
        {
