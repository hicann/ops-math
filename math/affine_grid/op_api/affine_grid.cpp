                                        ...
                                        aclTensor* out, aclOpExecutor* executor)
{
    ...
    OP_CHECK(ret == ACL_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "AffineGridAiCpu ADD_TO_LAUNCHER_LIST_AICPU failed."),
             return nullptr);
    return out;
}

const aclTensor* AffineGrid(const aclTensor* theta, const aclIntArray* size, bool alignCorners, aclOpExecutor* executor)
{
