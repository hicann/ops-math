...
int main()
{
    ...
    ret = aclnnAtan2GetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    // 调用aclnnAtan2第二段接口
    ret = aclnnAtan2(workspaceAddr.get(), workspaceSize, executor, stream.get());
    ...
    ret = aclnnInplaceAtan2GetWorkspaceSize(self.get(), other.get(), &inplaceWorkspaceSize, &inplaceExecutor);
    ...
    ret = aclnnInplaceAtan2(inplaceWorkspaceAddr.get(), inplaceWorkspaceSize, inplaceExecutor, stream.get());
