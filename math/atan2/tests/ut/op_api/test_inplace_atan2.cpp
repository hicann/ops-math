...
protected:
    static void SetUpTestCase() { std::cout << "inplace_atan2_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "inplace_atan2_test TearDown" << std::endl; }
};
...
TEST_F(l2_inplace_atan2_test, aclnnInplaceAtan2_self_shape_out_of_8)
{
    ...
    // self形状大于8
    auto self_out_of_shape_ut = OP_API_UT(aclnnInplaceAtan2, INPUT(out_shape_tensor_desc, normal_tensor_desc),
                                          OUTPUT());
    ...
    // other形状大于8
    auto other_out_of_shape_ut = OP_API_UT(aclnnInplaceAtan2, INPUT(normal_tensor_desc, out_shape_tensor_desc),
                                           OUTPUT());
