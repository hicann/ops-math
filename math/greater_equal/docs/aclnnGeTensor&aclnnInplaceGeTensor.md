...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnGeTensorGetWorkspaceSize”或者“aclnnInplaceGeTensorGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnGeTensor”或者“aclnnInplaceGeTensor”接口执行计算。
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的数据类型无法进行<a href="../../../docs/zh/context/deduction_relationship.md" target="_blank">推导</a>。</td>
    </tr>
    <tr>
