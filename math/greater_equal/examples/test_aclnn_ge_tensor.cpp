...
int main()
{
    ...
    ret = aclnnGeTensorGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnGeTensor(workspaceAddr.get(), workspaceSize, executor, stream.get());
