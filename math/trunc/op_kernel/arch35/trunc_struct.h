...
#ifndef CANN_CUSTOM_OPS_TRUNC_STRUCT_H_
#define CANN_CUSTOM_OPS_TRUNC_STRUCT_H_
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
        ASCENDC_TPL_DTYPE_SEL(dType, TPL_UINT8),
    ),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif //  CANN_CUSTOM_OPS_TRUNC_STRUCT_H_