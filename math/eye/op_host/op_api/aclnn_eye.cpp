...
static const std::initializer_list<DataType> DTYPE_SUPPORT_LIST = {DataType::DT_FLOAT, DataType::DT_INT32,
                                                                   ...
                                                                   DataType::DT_INT16, DataType::DT_UINT8,
                                                                   DataType::DT_INT64, DataType::DT_BOOL};
static const std::initializer_list<DataType> DTYPE_SUPPORT_LIST_910B = {DataType::DT_FLOAT, DataType::DT_INT32,
                                                                   DataType::DT_FLOAT16, DataType::DT_INT8,
                                                                   DataType::DT_INT16, DataType::DT_UINT8,
                                                                   DataType::DT_INT64, DataType::DT_BOOL,
                                                                   DataType::DT_BF16};
...
static bool CheckShape(const aclTensor *out, const int64_t n, const int64_t m) {
  ...
  if (outShape.GetDim(0) != n || outShape.GetDim(1) != m) {
    OP_LOGE(ACLNN_ERR_PARAM_INVALID, "Expected out shape to be (%ld, %ld), but got %s.",
            n, m, op::ToString(outShape).GetString());
    return false;
  }
