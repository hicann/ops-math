...
public:
    ...
    {
        this->Input("input_x").ParamType(REQUIRED).DataType(dataType).UnknownShapeFormat(format);

        this->Input("input_y").ParamType(REQUIRED).DataType(dataType).UnknownShapeFormat(format);

        this->Output("output").ParamType(REQUIRED).DataType(dataType).UnknownShapeFormat(format);
