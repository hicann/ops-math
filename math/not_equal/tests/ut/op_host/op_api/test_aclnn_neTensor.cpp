...
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_uint8) {
  ...
  auto tensor_other = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<uint8_t>{3, 4, 5, 6, 7, 8});
...
// 正常场景 int16
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_int16) {
  ...
  auto tensor_other = TensorDesc({2, 3}, ACL_INT16, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<int16_t>{3, 4, 5, 6, 7, 8});
...
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_int64) {
  auto tensor_self = TensorDesc({2, 3}, ACL_INT64, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<int64_t>{3, 4, 9, 6, 7, 11});

  auto tensor_other = TensorDesc({2, 3}, ACL_INT64, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<int64_t>{3, 4, 5, 6, 7, 8});
...
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_complex64) {
...
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_complex128) {
...
// 正常场景 double
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_double) {
  auto tensor_self = TensorDesc({2, 3}, ACL_DOUBLE, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<double>{3, 4, 9, 6, 7, 11});

  auto tensor_other = TensorDesc({2, 3}, ACL_DOUBLE, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<double>{3, 4, 5, 6, 7, 8});
...
// 异常场景 bf16
TEST_F(l2_ne_tensor_test, test_ne_tensor_not_support_bf16) {
...
TEST_F(l2_ne_tensor_test, test_ne_tensor_support_bool) {
  ...
  auto tensor_other = TensorDesc({2, 3}, ACL_BOOL, ACL_FORMAT_ND)
                         .Value(vector<bool>{true, true, false, true, false, false});
