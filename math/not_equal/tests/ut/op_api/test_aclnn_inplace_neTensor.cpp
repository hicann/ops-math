...
#include "math/not_equal/op_api/aclnn_ne_tensor.h"
...
TEST_F(l2_inplace_ne_tensor_test, test_inplace_ne_tensor_support_HWCN) {
  auto tensor_self_ref =
      TensorDesc({2, 3, 1, 1}, ACL_INT8, ACL_FORMAT_HWCN).ValueRange(-10, 10).Value(vector<int8_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_inplace_ne_tensor_test, test_inplace_ne_tensor_support_NHWC) {
  auto tensor_self_ref =
      TensorDesc({2, 3, 1, 1}, ACL_INT8, ACL_FORMAT_NHWC).ValueRange(-10, 10).Value(vector<int8_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_inplace_ne_tensor_test, test_inplace_ne_tensor_support_NCHW) {
  auto tensor_self_ref =
      TensorDesc({2, 3, 1, 1}, ACL_INT8, ACL_FORMAT_NCHW).ValueRange(-10, 10).Value(vector<int8_t>{3, 4, 9, 6, 7, 11});
