...
def write_file_txt(file_name, data, fmt="%s"):
    if file_name is None:
        print("file name is empty, do not write data to file")
        return
...
def gen_random_data_int8_1():
    data_files = [
        "cumsum/data/cumsum_data_input_int8.txt",
...
def gen_random_data_int16_1():
    data_files = [
        "cumsum/data/cumsum_data_input_int16.txt",
...
def gen_random_data_int32_1():
    data_files = [
        "cumsum/data/cumsum_data_input_int32.txt",
...
def gen_random_data_int64_1():
    data_files = [
        "cumsum/data/cumsum_data_input_int64.txt",
...
def gen_random_data_uint8_1():
    data_files = [
        "cumsum/data/cumsum_data_input_uint8.txt",
...
def gen_random_data_uint16_1():
    data_files = [
        "cumsum/data/cumsum_data_input_uint16.txt",
...
def gen_random_data_float16_1():
    data_files = [
        "cumsum/data/cumsum_data_input_float16.txt",
...
def gen_random_data_float32_1():
    data_files = [
        "cumsum/data/cumsum_data_input_float32.txt",
...
def gen_random_data_float64_1():
    data_files = [
        "cumsum/data/cumsum_data_input_float64.txt",
...
def gen_random_data_complex64_1():
    data_files = [
        "cumsum/data/cumsum_data_input_complex64.txt",
...
def gen_random_data_complex128_1():
    data_files = [
        "cumsum/data/cumsum_data_input_complex128.txt",
...
def gen_random_data_double_big_1():
    data_files = [
        "cumsum/data/cumsum_data_input_double.txt",
