...
static const inline std::initializer_list<DataType>& GetSupportDtypeList(NpuArch npuArch)
{
    ...
    if (npuArch == NpuArch::DAV_2002 || npuArch == NpuArch::DAV_1001 || npuArch == NpuArch::DAV_3002) {
...
aclnnStatus aclnnCumsumV2GetWorkspaceSize(const aclTensor* self, int64_t dim, bool exclusive, bool reverse,
