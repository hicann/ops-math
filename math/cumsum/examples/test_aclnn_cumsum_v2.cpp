...
int main()
{
    ...
    ret = aclnnCumsumV2GetWorkspaceSize(self.get(), dim, exclusive, reverse, out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnCumsumV2(workspaceAddr.get(), workspaceSize, executor, stream.get());
