...
// int8
TEST_F(l2_addn_test, l2_addn_test_dypte_int8) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_INT8, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_INT8, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// int16
TEST_F(l2_addn_test, l2_addn_test_dypte_int16) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_INT16, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_INT16, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// uint8
TEST_F(l2_addn_test, l2_addn_test_dypte_uint8) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// uint16
TEST_F(l2_addn_test, l2_addn_test_dypte_uint16) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_UINT16, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_UINT16, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto out_tensor_desc = TensorDesc({2, 3}, ACL_UINT16, ACL_FORMAT_ND);
    auto tensor_list_desc = TensorListDesc({tensor_1_desc, tensor_2_desc});
    auto ut = OP_API_UT(aclnnAddN, INPUT(tensor_list_desc), OUTPUT(out_tensor_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
...
// uint32
TEST_F(l2_addn_test, l2_addn_test_dypte_uint32) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_UINT32, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_UINT32, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// uint64
TEST_F(l2_addn_test, l2_addn_test_dypte_uint64) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_UINT64, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_UINT64, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// double
TEST_F(l2_addn_test, l2_addn_test_dypte_double) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_DOUBLE, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_DOUBLE, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// complex64
TEST_F(l2_addn_test, l2_addn_test_dypte_complex64) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_COMPLEX64, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_COMPLEX64, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
...
// complex128
TEST_F(l2_addn_test, l2_addn_test_dypte_complex128) {
    auto tensor_1_desc = TensorDesc({2, 3}, ACL_COMPLEX128, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
    auto tensor_2_desc = TensorDesc({2, 3}, ACL_COMPLEX128, ACL_FORMAT_ND).Value(vector<float>{1, 2, 3, 4, 5, 6});
