 ...
 */
ACLNN_API aclnnStatus aclnnSignBitsUnpackGetWorkspaceSize(
...
aclnnSignBitsUnpack(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
