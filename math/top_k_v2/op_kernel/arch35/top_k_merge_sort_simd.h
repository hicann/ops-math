 ...
 */
/*!
 * \file top_k_merge_sort_simd.h
 * \brief top_k_merge_sort kernel entry
 */
#ifndef TOP_K_MERGE_SORT_SIMD_H
#define TOP_K_MERGE_SORT_SIMD_H
...
public:
    ...
    __aicore__ inline void MergeSortInitBuffer(uint32_t currTileSize, uint32_t oneCoreRowNum,
