                         ...
                         aclOpExecutor* executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICPU(Cumprod, OP_ATTR_NAMES({"exclusive", "reverse", "Tidx"}), OP_INPUT(x, axis),
                                          OP_OUTPUT(out), OP_ATTR(exclusive, reverse, ge::DataType::DT_INT32));
