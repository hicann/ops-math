...
class l2_logical_and_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "logical_and_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "logical_and_test TearDown" << endl; }
};
...
// TEST_F(l2_logical_and_test, aclnnLogicalAnd_1_11_34_22_19_6_5_1_float_nd_23_11_34_22_1_1_5_5_float_ValueRange_testcase018) {
//   // left input
//   const vector<int64_t>& selfShape = {1,11,34,22,19,6,5,1};
//   aclDataType selfDtype = ACL_FLOAT;
//   aclFormat selfFormat = ACL_FORMAT_ND;
