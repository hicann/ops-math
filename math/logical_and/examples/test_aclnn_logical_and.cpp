...
int main()
{
    ...
    ret = aclnnLogicalAndGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnLogicalAnd(workspaceAddr.get(), workspaceSize, executor, stream.get());
