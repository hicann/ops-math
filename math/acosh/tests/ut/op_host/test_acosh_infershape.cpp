...
class AcoshInferShapeTest : public testing::Test {};

TEST_F(AcoshInferShapeTest, DynamicDimension)
{
    gert::InfershapeContextPara contextPara("Acosh",
                                            {
...
TEST_F(AcoshInferShapeTest, UnknownRank)
{
    gert::InfershapeContextPara contextPara("Acosh",
                                            {
