...
static const std::initializer_list<op::DataType> ASCEND910B_AICORE_DTYPE_SUPPORT_LIST = {
    op::DataType::DT_FLOAT, op::DataType::DT_FLOAT16, op::DataType::DT_INT8,
    op::DataType::DT_INT32, op::DataType::DT_UINT8, op::DataType::DT_BF16, op::DataType::DT_BOOL};
...
static const aclTensor *OnesLikeAiCPU(const aclTensor *self, const aclTensor *out, aclOpExecutor *executor) {
  ...
  if (IsComplexType(self->GetDataType()) || (self->GetDataType() == ge::DataType::DT_BF16)) {
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICPU(OnesLike, OP_ATTR_NAMES({"T"}),
                                          OP_INPUT(self), OP_OUTPUT(out),
                                          OP_ATTR(self->GetDataType()));
