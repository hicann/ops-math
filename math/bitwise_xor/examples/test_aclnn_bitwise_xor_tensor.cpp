...
int main()
{
    ...
    ret = aclnnBitwiseXorTensorGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnBitwiseXorTensor(workspaceAddr.get(), workspaceSize, executor, stream.get());
