...
- **参数说明：**
  ...
  <!-- npu="950" id10 -->
  - <term>Ascend 950PR/Ascend 950DT</term>：selfRef和other数据类型需满足[TensorScalar互推导关系](../../../docs/zh/context/互推导关系.md)，且需要是推导之后可转换的数据类型（参见[互转换关系](../../../docs/zh/context/互转换关系.md)）。
  <!-- end id10 -->
