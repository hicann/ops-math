...
class l2_le_scalar_test : public testing::Test {
 protected:
  ...
  static void TearDownTestCase() { std::cout << "le_scalar_test TearDown" << std::endl; }
};
...
TEST_F(l2_le_scalar_test, test_le_scalar_int8) {
  auto tensor_self = TensorDesc({2, 3}, ACL_INT8, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<int8_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_le_scalar_test, test_le_scalar_uint8) {
  auto tensor_self = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<uint8_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_le_scalar_test, test_le_scalar_int16) {
  auto tensor_self = TensorDesc({2, 3}, ACL_INT16, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<int16_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_le_scalar_test, test_le_scalar_int32) {
  auto tensor_self = TensorDesc({2, 3}, ACL_INT32, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<int32_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_le_scalar_test, test_le_scalar_int64) {
  auto tensor_self = TensorDesc({2, 3}, ACL_INT64, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<int64_t>{3, 4, 9, 6, 7, 11});
...
TEST_F(l2_le_scalar_test, test_le_scalar_support_bool) {
  auto tensor_self = TensorDesc({2, 3}, ACL_BOOL, ACL_FORMAT_ND)
                                .Value(std::vector<bool>{false, true, false, true, false, false});
...
TEST_F(l2_le_scalar_test, test_le_scalar_notsupport_bf16) {
    auto tensor_self = TensorDesc({2, 3, 3}, ACL_BF16, ACL_FORMAT_ND)
                            .ValueRange(-10, 10)
    ...
    auto out_tensor_desc = TensorDesc({2, 3, 3}, ACL_BOOL, ACL_FORMAT_ND)
                            .Value(std::vector<bool>{false, false, false,
                                                false, false, false});
...
TEST_F(l2_le_scalar_test, test_le_scalar_int8_int16_cast) {
    auto tensor_self = TensorDesc({2, 3, 1}, ACL_INT8, ACL_FORMAT_ND)
                                .ValueRange(-10, 10)
                                .Value(std::vector<int8_t>{1,2,3,1,2,3});
...
TEST_F(l2_le_scalar_test, test_le_scalar_error_shape) {
  auto self_tensor_desc = TensorDesc({2,2,2,2,2,2,2,2,2,2}, ACL_FLOAT, ACL_FORMAT_ND)
                         .ValueRange(-10, 10);
