...
class inplaceLeScalar_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "inplaceLeScalar_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "inplaceLeScalar_test TearDown" << endl; }
};

TEST_F(inplaceLeScalar_test, case_norm_float32) {
...
TEST_F(inplaceLeScalar_test, case_norm_float16) {
...
TEST_F(inplaceLeScalar_test, case_norm_int64) {
...
TEST_F(inplaceLeScalar_test, case_norm_int32) {
...
TEST_F(inplaceLeScalar_test, case_norm_int8) {
...
TEST_F(inplaceLeScalar_test, case_norm_uint8) {
...
TEST_F(inplaceLeScalar_test, case_norm_int16) {
...
TEST_F(inplaceLeScalar_test, case_norm_double) {
...
TEST_F(inplaceLeScalar_test, case_empty_tensor) {
...
TEST_F(inplaceLeScalar_test, case_strided) {
