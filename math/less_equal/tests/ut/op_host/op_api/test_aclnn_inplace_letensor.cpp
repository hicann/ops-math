...
TEST_F(l2_inplace_le_tensor_test, test_inplace_le_tensor_normal_support_uint88) {
  auto tensor_self = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<uint64_t>{3, 4, 9, 6, 7, 6});

  auto tensor_other = TensorDesc({2, 3}, ACL_UINT8, ACL_FORMAT_ND)
                         .ValueRange(-10, 10)
                         .Value(vector<uint64_t>{3, 4, 4, 6, 7, 6});
...
TEST_F(l2_inplace_le_tensor_test, test_inplace_le_tensor_normal_input_bool) {
  auto tensor_self = TensorDesc({2, 3}, ACL_BOOL, ACL_FORMAT_ND)
                         .Value(vector<bool>{true, true, true, false, false, false});

  auto tensor_other = TensorDesc({2, 3}, ACL_BOOL, ACL_FORMAT_ND)
                         .Value(vector<int8_t>{false, false, false, true, true, true});
...
TEST_F(l2_inplace_le_tensor_test, test_inplace_le_tensor_input_cannot_broadcast) {
  auto tensor_self = TensorDesc({2, 1}, ACL_FLOAT, ACL_FORMAT_ND)
                         .ValueRange(-10, 10);

  auto tensor_other = TensorDesc({1, 2}, ACL_FLOAT, ACL_FORMAT_ND)
                         .ValueRange(-10, 10);
