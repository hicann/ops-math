...
int main()
{
    ...
    ret = aclnnLeTensorGetWorkspaceSize(self.get(), other.get(), out.get(), &workspaceSize, &executor);
    ...
    ret = aclnnLeTensor(workspaceAddr.get(), workspaceSize, executor, stream.get());
