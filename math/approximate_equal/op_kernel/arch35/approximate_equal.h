...
#ifndef APPROXIMATE_EQUAL_H_
#define APPROXIMATE_EQUAL_H_
...
private:
    ...
    {
        constexpr int64_t COMPARE_TYPE_SIZE = NEEDS_CAST ? static_cast<int64_t>(sizeof(float))
                                                        : static_cast<int64_t>(sizeof(T));
        constexpr int64_t COMPARE_ALIGN_ELEMS = 256 / COMPARE_TYPE_SIZE;
