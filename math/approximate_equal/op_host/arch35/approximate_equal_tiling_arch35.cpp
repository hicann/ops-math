...
#include "../../op_kernel/arch35/approximate_equal_tiling_data.h"
#include "../../op_kernel/arch35/approximate_equal_tiling_key.h"
                                     ...
                                     uint64_t ubSize, int64_t coreNum, ge::DataType dataType)
{
    ...
    constexpr int64_t MAX_BLOCK_LEN_BYTES = 65535;
    int64_t maxUbFactorByBlockLen = FloorAlign(MAX_BLOCK_LEN_BYTES / inputTypeSize, alignElems);
