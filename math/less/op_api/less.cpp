...
// AICORE算子kernel
static const aclTensor *LessAiCore(const aclTensor *self, const aclTensor *other,
    aclTensor *ltOut, aclOpExecutor *executor) {
  ...
  OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "LessAiCore ADD_TO_LAUNCHER_LIST_AICORE failed."), return nullptr);
  return ltOut;
}

// AICPU算子kernel
static const aclTensor *LessAiCpu(const aclTensor *self, const aclTensor *other,
    aclTensor *ltOut, aclOpExecutor *executor) {
  ...
  OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "LessAiCpu ADD_TO_LAUNCHER_LIST_AICPU failed."), return nullptr);
  return ltOut;
}
