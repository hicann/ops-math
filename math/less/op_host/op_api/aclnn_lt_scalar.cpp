...
static bool CheckPromoteTypeScalar(const aclTensor *self, const aclScalar *other,
...
static aclnnStatus CheckParamsScalar(const aclTensor *self, const aclScalar *other,
                                     const aclTensor *out, DataType promote) {
  // 1. 检查参数是否为空指针
...
// inplace lt scalar
aclnnStatus aclnnInplaceLtScalarGetWorkspaceSize(const aclTensor *selfRef,
