                                                ...
                                                aclTensor* invstdOut, uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    int64_t correction = 0;
    auto reduceStdWithMeanResult = l0op::ReduceStdWithMean(reformat, broadcast, axes, correction, false, true,
...
aclnnStatus aclnnBatchNormStats(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
