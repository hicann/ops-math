 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnStdMeanCorrectionGetWorkspaceSize(
...
aclnnStdMeanCorrection(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
