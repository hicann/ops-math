...
#define ADD_INPUT(inputIndex, inputName, inputDtype, inputShape)                                                     \
    ...
    sub1.set_input_##inputName(placeholder##inputIndex);                                                     \
...
#define ADD_CONST_INPUT(inputIndex, inputName, inputDtype, inputShape)                                               \
    ...
    graph.AddOp(placeholder##inputIndex);                                                                            \
    sub1.set_input_##inputName(placeholder##inputIndex);                                                     \
    sub1.update_input_desc_##inputName(placeholder##inputIndex##_desc);                                      \
    inputs.push_back(placeholder##inputIndex);
    ...
    std::vector<Operator> &outputs, Graph &graph)
{
    ...
    ADD_INPUT(2, x2, inDtype, yShape);
     
    outputs.push_back(sub1);
    // 添加完毕
    return SUCCESS;
}
...
int main(int argc, char *argv[])
{
    ...
    const int input_num = input.size();
    ...
    const int output_num = output.size();
