 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnVarGetWorkspaceSize(
 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnVarCorrectionGetWorkspaceSize(
...
aclnnVarCorrection(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
