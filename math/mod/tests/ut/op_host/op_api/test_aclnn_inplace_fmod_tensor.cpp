...
TEST_F(l2_inplace_fmod_tensor_test, aclnnInplaceFmodTensor_001_float32_HWCN) {
  auto tensor_self = TensorDesc({2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_HWCN).ValueRange(-10, -1).Precision(0.0001, 0.0001);
...
TEST_F(l2_inplace_fmod_tensor_test, aclnnInplaceFmodTensor_004_float16_float_NHWC) {
  auto tensor_self = TensorDesc({2, 3, 4, 5}, ACL_FLOAT16, ACL_FORMAT_NHWC).ValueRange(-10, -1).Precision(0.001, 0.001);
...
TEST_F(l2_inplace_fmod_tensor_test, aclnnInplaceFmodTensor_005_int32_float16_ND) {
  auto tensor_self = TensorDesc({7, 9, 11, 3, 4, 6}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-10, -1).Precision(0.0001, 0.0001);
...
TEST_F(l2_inplace_fmod_tensor_test, aclnnInplaceFmodTensor_006_float_int32_bool_broadcast_ND) {
  auto tensor_self = TensorDesc({7, 9, 11, 3, 4, 6, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, -1).Precision(0.0001, 0.0001);
...
TEST_F(l2_inplace_fmod_tensor_test, aclnnInplaceFmodTensor_008_input_not_contiguous) {
  auto tensor_self = TensorDesc({2, 4}, ACL_FLOAT, ACL_FORMAT_ND, {1, 2}, 0, {4, 2}).ValueRange(-10, -1).Precision(0.0001, 0.0001);
