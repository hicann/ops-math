...
/*!
 * \file fused_mul_addn_l2loss.cpp
 * \brief FusedMulAddNL2loss arch35 kernel entry（fp16/fp32 双二进制，DTYPE_X1 编译期分发）
 */

#include <type_traits>
#include "arch35/fused_mul_addn_l2loss.h"

using namespace FusedMulAddNL2lossOps;

extern "C" __global__ __aicore__ void fused_mul_addn_l2loss(GM_ADDR x1, GM_ADDR x2, GM_ADDR x3, GM_ADDR y1, GM_ADDR y2,
