...
- <term>Atlas A3 训练系列产品/Atlas A3 推理系列产品, Atlas A2 训练系列产品/Atlas A2 推理系列产品, Atlas 200I/500 A2 推理产品, Atlas 推理系列产品, Atlas 训练系列产品</term>：x1、x2、x3、y1、y2的数据类型不支持FLOAT16，只支持FLOAT。
...
| 调用方式 | 调用样例                                                                   | 说明                                                             |
|--------------|------------------------------------------------------------------------|----------------------------------------------------------------|
| 图模式调用 | [test_geir_fused_mul_addn_l2loss](./examples/arch35/test_geir_fused_mul_addn_l2loss.cpp)   | 通过[算子IR](./op_graph/fused_mul_addn_l2loss_proto.h)构图方式调用FusedMulAddNL2loss算子。 |
