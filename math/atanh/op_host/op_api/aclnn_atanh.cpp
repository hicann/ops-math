...
static bool CheckDtypeValid(const aclTensor* input, const aclTensor* out) {
  ...
  auto supportList = GetDtypeSupportListV1(ASCEND910B_DTYPE_DTYPE_SUPPORT_LIST_ATANH, ASCEND910_DTYPE_DTYPE_SUPPORT_LIST_ATANH);
...
static bool CheckInplaceDtypeValid(aclTensor *selfRef) {
  auto inplaceSupportList = GetDtypeSupportListV2(OUTPUT_DTYPE_SUPPORT_LIST_ATANH, ASCEND910_DTYPE_SELFREF_LIST_ATANH);
