...
/*!
 * \file reduce_min_dag.h
 * \brief reduce min dag
 */

#ifndef REDUCE_MIN_DAG_H
#define REDUCE_MIN_DAG_H
...
struct ReduceMinDag {
    ...
    using ReduceOp0 = Bind<Vec::ReduceMinOp<T>, OpCopyIn0>;
...
struct ReduceMinBf16Dag {
    using OpCopyIn0 = Bind<Vec::CopyIn<T>, Placeholder::In0<T>>;
    using Cast0 = Bind<Vec::Cast<PromteT, T, 0>, OpCopyIn0>;
    using ReduceOp0 = Bind<Vec::ReduceMinOp<PromteT>, Cast0>;
