...
TEST_F(reduce_min, reduce_min_infer_shape_rt01) {
  std::vector<int32_t> axesValue = {1, 0};
    ...
    "ReduceMin",
 	...
 	std::vector<std::vector<int64_t>> expectOutputShape = {{1, 1, 4}};
 	ExecuteTestCase(infershapeContextPara, ge::GRAPH_SUCCESS, expectOutputShape);
}

TEST_F(reduce_min, reduce_min_infer_shape_rt02) {
  std::vector<int32_t> axesValue = {1, 0};
 	gert::InfershapeContextPara infershapeContextPara(
    "ReduceMin",
 	  {
