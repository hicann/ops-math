...
protected:
    static void SetUpTestCase() { cout << "l2_min_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "l2_min_test TearDown" << endl; }
};

// self为空指针
TEST_F(l2_min_test, l2_min_test_nullptr_self)
{
    auto outDesc = TensorDesc({}, ACL_FLOAT, ACL_FORMAT_ND);

    auto ut = OP_API_UT(aclnnMin, INPUT(nullptr), OUTPUT(outDesc));
...
// out为空指针
TEST_F(l2_min_test, l2_min_test_nullptr_out)
{
    auto selfDesc = TensorDesc({2, 4}, ACL_FLOAT, ACL_FORMAT_ND);

    auto ut = OP_API_UT(aclnnMin, INPUT(selfDesc), OUTPUT(nullptr));
...
// 正常路径，float32
TEST_F(l2_min_test, l2_min_test_dtype_float32)
{
    ...
    auto ut = OP_API_UT(aclnnMin, INPUT(selfDesc), OUTPUT(outDesc));
...
// 正常路径，float16
TEST_F(l2_min_test, l2_min_test_dtype_float16)
{
...
// 正常路径，int64
TEST_F(l2_min_test, l2_min_test_dtype_int64)
{
...
// 正常路径，int32
TEST_F(l2_min_test, l2_min_test_dtype_int32)
{
...
// 正常路径，3维输入
TEST_F(l2_min_test, l2_min_test_3d)
{
...
// self为空tensor
TEST_F(l2_min_test, l2_min_test_empty_self)
{
...
// 用例不支持，最大维度超过8
TEST_F(l2_min_test, l2_min_test_dimension)
{
...
// 正常路径，bool类型
TEST_F(l2_min_test, l2_min_test_dtype_bool)
{
