 ...
 * \brief cdist_grad tiling key declare — normMode encoded as compile-time param
 */

#ifndef _CDIST_GRAD_TILING_KEY_H_
#define _CDIST_GRAD_TILING_KEY_H_

#include "atvoss/reduce/reduce_tiling_key_decl.h"

ASCENDC_TPL_ARGS_DECL(CdistGrad, REDUCE_TPL_KEY_DECL(),
    ASCENDC_TPL_UINT_DECL(normMode, 8, ASCENDC_TPL_UI_RANGE, 1, 0, 5));

ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(REDUCE_TPL_KEY_SEL_EMPTY(),
        ASCENDC_TPL_UINT_SEL(normMode, ASCENDC_TPL_UI_RANGE, 1, 0, 5)),
...
#endif  // _CDIST_GRAD_TILING_KEY_H_
