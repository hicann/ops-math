...
TEST_F(l2_cos_test, cos_dtype_all) {
  vector<aclDataType> input_vaild_dtype_list{ACL_INT8,  ACL_INT32,   ACL_UINT8,  ACL_INT16,     ACL_INT64,     ACL_BOOL,
                                             ACL_FLOAT, ACL_FLOAT16, ACL_DOUBLE, ACL_COMPLEX64, ACL_COMPLEX128};
