...
int main()
{
    ...
    // 调用aclnnCos第一段接口
    ret = aclnnCosGetWorkspaceSize(self.get(), out.get(), &workspaceSize, &executor);
    ...
    // 调用aclnnCos第二段接口
    ret = aclnnCos(workspaceAddr.get(), workspaceSize, executor, stream.get());
    ...
    ret = aclnnInplaceCosGetWorkspaceSize(self.get(), &workspaceSize, &executor);
    ...
    ret = aclnnInplaceCos(workspaceAddr.get(), workspaceSize, executor, stream.get());
