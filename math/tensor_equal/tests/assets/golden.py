...
__golden__ = {
    "aclnn": {
        "aclnnEqual": "aclnn_equal_golden",
    },
    "kernel": {"tensor_equal": "tensor_equal_golden"},
}
...
def aclnn_equal_golden(self, other, out=None, **kwargs):
    return [torch.tensor(torch.equal(self, other))]
