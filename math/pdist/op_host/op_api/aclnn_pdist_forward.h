 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnPdistForwardGetWorkspaceSize(
...
aclnnPdistForward(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
