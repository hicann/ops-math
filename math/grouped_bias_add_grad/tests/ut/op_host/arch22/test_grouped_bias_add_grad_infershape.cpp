...
protected:
    static void SetUpTestCase() { std::cout << "GroupedBiasAddGrad SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupedBiasAddGrad TearDown" << std::endl; }
};
...
TEST_F(GroupedBiasAddGrad, GroupedBiasAddGrad_infershape_case_0)
{
    ...
    std::vector<gert::StorageShape> inputShapes = {{{40, 6912}, {40, 6912}}, {{10}, {10}}};
