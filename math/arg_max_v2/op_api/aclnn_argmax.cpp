...
static bool ComputeShape(const aclTensor* self, FVector<int64_t>& newShapeVector, FVector<int64_t>& outShapeVector,
                         int64_t& dim, const bool keepdim)
{
                                        ...
                                        uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    if (CheckIfNeedReshape(self)) {
        ...
        argmaxOut = l0op::ArgMaxV2(selfContiguous, realDim, keepdim, out->GetDataType(), uniqueExecutor.get());
