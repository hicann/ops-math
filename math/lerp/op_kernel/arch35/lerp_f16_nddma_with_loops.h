...
private:
                                    ...
                                    int64_t ubLoopIdx)
    {
        ...
        __VEC_SCOPE__
        {
            ...
            __ubuf__ half* bufferIn2Addr = (__ubuf__ half*)bufferIn2_.GetPhyAddr();
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::Reg::Compares<float, AscendC::CMPMODE::LT>(preg2, vreg1, static_cast<float>(0.5), preg0);
                AscendC::Reg::LoadAlign<half, AscendC::Reg::LoadDist::DIST_UNPACK_B16>(
                ...
                AscendC::Reg::Cast<float, half, castTrait0>(vreg5, vreg4, preg0);
                ...
                AscendC::Reg::Select<float>(vreg9, vreg5, vreg3, preg2);
                AscendC::Reg::Cast<half, float, castTrait1>(vreg10, vreg9, preg0);
