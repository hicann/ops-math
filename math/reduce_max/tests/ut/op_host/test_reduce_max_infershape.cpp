...
protected:
    static void SetUpTestCase() { std::cout << "ReduceMaxTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ReduceMaxTest TearDown" << std::endl; }
};

// ==================== 非空axes, DT_INT32, keep_dims=true ====================
TEST_F(ReduceMaxTest, ReduceMax_const_infer_1)
{
...
TEST_F(ReduceMaxTest, ReduceMax_const_infer_2)
{
    std::vector<int32_t> axesValue = {1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_const_infer_scalar)
{
...
// ==================== 标量输入, keep_dims=true ====================
TEST_F(ReduceMaxTest, ReduceMax_scalar_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
// 输出shape与输入相同
TEST_F(ReduceMaxTest, ReduceMax_empty_axes_noop_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
        {
...
// 所有轴归约为1
TEST_F(ReduceMaxTest, ReduceMax_empty_axes_noop_false_keepdims_true)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
        {
...
// 输出为标量
TEST_F(ReduceMaxTest, ReduceMax_empty_axes_noop_false_keepdims_false)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
        {
...
// 标量输入保持不变
TEST_F(ReduceMaxTest, ReduceMax_empty_axes_noop_true_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
        {
...
// ==================== 标量继续保持标量
TEST_F(ReduceMaxTest, ReduceMax_empty_axes_noop_false_scalar)
{
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
        {
...
TEST_F(ReduceMaxTest, ReduceMax_zero_dim_axes_noop_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_zero_dim_axes_noop_false_keepdims_false)
{
    std::vector<int32_t> axesValue = {};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_int64_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_int64_keepdims_false)
{
    std::vector<int64_t> axesValue = {1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_int64_neg_axes_keepdims_true)
{
    std::vector<int64_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_int64_neg_axes_keepdims_false)
{
...
TEST_F(ReduceMaxTest, ReduceMax_invalid_axes_dtype)
{
...
TEST_F(ReduceMaxTest, ReduceMax_invalid_axes_bounds)
{
...
TEST_F(ReduceMaxTest, ReduceMax_invalid_axes_bounds_neg)
{
...
TEST_F(ReduceMaxTest, ReduceMax_invalid_axes_bounds_scalar)
{
...
TEST_F(ReduceMaxTest, ReduceMax_all_dims_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_all_dims_keepdims_false)
{
    std::vector<int32_t> axesValue = {0, 1, 2, 3};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_1d_keepdims_true)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_1d_keepdims_false)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
// ==================== 单轴归约, keep_dims=true ====================
TEST_F(ReduceMaxTest, ReduceMax_single_axis_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_single_axis_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_dynamic_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_dynamic_keepdims_false)
{
    std::vector<int32_t> axesValue = {1};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_neg_axes_keepdims_true)
{
    std::vector<int32_t> axesValue = {-1, -2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_int64_5d_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_int64_5d_keepdims_false)
{
    std::vector<int64_t> axesValue = {2, 4};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_int64_scalar_keepdims_true)
{
...
TEST_F(ReduceMaxTest, ReduceMax_multi_dim_axes_flatten)
{
    std::vector<int32_t> axesValue = {1, 2};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
// ==================== 未知秩输入 ({-2}) → 输出 {-2} ====================
TEST_F(ReduceMaxTest, ReduceMax_unknown_rank)
{
    std::vector<int32_t> axesValue = {0};
    gert::InfershapeContextPara infershapeContextPara(
        "ReduceMax",
...
TEST_F(ReduceMaxTest, ReduceMax_infer_datatype)
{
    auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
    ASSERT_NE(spaceRegistry, nullptr);
    auto opImpl = spaceRegistry->GetOpImpl("ReduceMax");
    ASSERT_NE(opImpl, nullptr);
    ASSERT_NE(opImpl->infer_datatype, nullptr);

    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("ReduceMax").OpName("ReduceMax");
    builder.IONum(2, 1);
...
TEST_F(ReduceMaxTest, ReduceMax_infer_shape_range)
{
    auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
    ASSERT_NE(spaceRegistry, nullptr);
    auto opImpl = spaceRegistry->GetOpImpl("ReduceMax");
