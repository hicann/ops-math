...
protected:
    static void SetUpTestCase() { cout << "minimum_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "minimum_test TearDown" << endl; }
};
...
TEST_F(l2_minimum_test, aclnnMinimum_026_1_aclnnMinimum_ascend950_out_dtype_compute)
{
