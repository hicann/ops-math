...
#include "../../../../op_host/op_api/aclnn_minn.h"
#include "op_api_ut_common/tensor_desc.h"
#include "op_api_ut_common/scalar_desc.h"
#include "op_api_ut_common/op_api_ut.h"
#include "op_api_ut_common/inner/types.h"

class l2_minn_test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "l2_minn_test SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "l2_minn_test TearDown" << std::endl;
    }
};

// 输入为空指针
TEST_F(l2_minn_test, l2_minn_test_nullptr_input)
{
    auto outTensorDesc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnMinN, INPUT(nullptr), OUTPUT(outTensorDesc));
...
// 输出为空指针
TEST_F(l2_minn_test, l2_minn_test_nullptr_output)
{
    ...
    auto ut = OP_API_UT(aclnnMinN, INPUT(tensorListDesc), OUTPUT(nullptr));
    uint64_t workspaceSize = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspaceSize);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}
...
// 空tensors
TEST_F(l2_minn_test, l2_minn_test_empty_tensors)
{
    auto tensor1Desc = TensorDesc({0}, ACL_FLOAT, ACL_FORMAT_ND);
    auto tensor2Desc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    auto tensorListDesc = TensorListDesc({tensor1Desc, tensor2Desc});
    auto outTensorDesc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnMinN, INPUT(tensorListDesc), OUTPUT(outTensorDesc));
    uint64_t workspaceSize = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspaceSize);
...
// 不能广播
TEST_F(l2_minn_test, l2_minn_test_broadcast_failed1)
{
...
TEST_F(l2_minn_test, l2_minn_test_broadcast_failed2)
{
...
// 输入维度超过8
TEST_F(l2_minn_test, l2_minn_test_dim_over_8)
{
...
// 正常路径
TEST_F(l2_minn_test, l2_minn_test_dypte_float32)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_float16)
{
...
TEST_F(l2_minn_test, ascend910B2_minn_dypte_bfloat16)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_int64)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_int32)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_int8)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_tensor_num_1)
{
...
TEST_F(l2_minn_test, l2_minn_test_dypte_tensor_num_20)
{
    auto tensor1Desc = TensorDesc({2, 1}, ACL_FLOAT16, ACL_FORMAT_ND).Value(vector<float>{1, 2});
...
TEST_F(l2_minn_test, l2_minn_test_empty_tensor_21)
{
