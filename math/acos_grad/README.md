...
- 超出定义域（$|y_i| > 1$）时：$1 - y_i^2 < 0$，平方根结果为NaN，结果同样为NaN。
...
<table style="undefined;table-layout: fixed; width: 1576px"><colgroup>
  ...
  <tbody>
    <tr>
      <td>y</td>
      <td>输入</td>
      <td>前向Acos算子的输入张量。值域期望落在 [-1, 1]。</td>
...
| 调用方式 | 调用样例                                                                | 说明                                                                                       |
| -------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| 图模式调用 | [test_geir_acos_grad](./examples/test_geir_acos_grad.cpp)               | 通过 [算子IR](./op_graph/acos_grad_proto.h)构图方式调用AcosGrad算子。                   |
