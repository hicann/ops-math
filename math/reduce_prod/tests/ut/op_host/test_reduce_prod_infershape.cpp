...
// TEST_F(ReduceProdTest, ReduceProd_infer_datatype)
// {
//     auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
//     ASSERT_NE(spaceRegistry, nullptr);
//     auto opImpl = spaceRegistry->GetOpImpl("ReduceProd");
//     ASSERT_NE(opImpl, nullptr);
//     ASSERT_NE(opImpl->infer_datatype, NULL);

//     gert::OpInferDataTypeContextBuilder builder;
//     builder.OpType("ReduceProd").OpName("ReduceProd");
//     builder.IONum(2, 1);
...
TEST_F(ReduceProdTest, ReduceProd_infer_shape_range)
{
    auto spaceRegistry = gert::DefaultOpImplSpaceRegistryV2::GetInstance().GetSpaceRegistry();
    ASSERT_NE(spaceRegistry, nullptr);
    auto opImpl = spaceRegistry->GetOpImpl("ReduceProd");
