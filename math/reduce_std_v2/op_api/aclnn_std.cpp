...
#include "aclnn_std.h"
#include <bitset>
#include "math/reduce_std_with_mean/op_api/reduce_std_with_mean.h"
                                     ...
                                     bool keepdim, aclTensor* out, uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    bool invert = false;
    float eps = 0.001f;
    stdWithMeanOpOut = l0op::ReduceStdWithMean(selfContiguous, expandOpOut, dimArray, correction, keepdim, invert, eps,
                                               uniqueExecutor.get());
